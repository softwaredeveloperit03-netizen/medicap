...
@Component({
  selector: 'app-spinprocess-formulation',
  templateUrl: './spinprocess-formulation.component.html',
  styleUrls: ['./spinprocess-formulation.component.css'],
  providers: [DatePipe]
})
export class SpinprocessFormulationComponent implements OnInit {
  unit_conversion;
  isView = false;
  qa_checking = 'Yes';
  prod_checking = 'Yes';
  ...
  getAcceptedRequests() {
    this.service.get('store/dispensing.php?type=get_Dispensing_Requests_For_Inprocess_Activity_Formulation1&material_type=Raw Material&rpt_type=Request').subscribe(response => {
