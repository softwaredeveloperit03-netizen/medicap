...
export class CompleteComponent implements OnInit {
  ...
  getAcceptedRequests(){
    //this.service.get('store/dispensing.php?type=getActiveDispensing').subscribe(response => {
      this.service.get('store/dispensing.php?type=get_Dispensing_Requests_For_Inprocess_Activity_FormulationComplete&material_type=Raw Material&rpt_type=Completed').subscribe(response => {
  ...
  viewshow(index) {
    ...
    this.service.get('store/dispensing.php?type=get_dispensing_Activity_By_Id&id=' + this.selectedMaterial["dispence_id"]).subscribe(response => {
      ...
      try {
        ...
        console.error('Error parsing JSON for "ars":', e);
       }
  
      try {
         this.available_ars = JSON.parse(data['containers']);
      } catch (e) {
        console.error('Error parsing JSON for "containers":', e);
       }
