...
export class DashboardComponent implements OnInit {
  cards: QcDeptCard[] = [
    ...
    { id: 'label', title: 'Label Printing', route: 'label', icon: 'fa-tag', category: 'Modules', gradient: 'linear-gradient(135deg, #fa709a 0%, #764ba2 100%)' },
    { id: 'correction', title: 'Correction', route: 'correction', icon: 'fa-pencil-alt', category: 'Modules', gradient: 'linear-gradient(135deg, #30cfd0 0%, #764ba2 100%)' },
  ];
