...
export class DashboardComponent implements OnInit {
  pageTitle = 'Raw / Packing Material';
  sidebarTitle = 'Raw Material Modules';
  sectionLabel = 'Raw Material Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'store_raw_dashboard_category';
  private readonly paletteKey = 'store_raw_dashboard_palette';

  readonly categories: HubCategory[] = [
    { id: 'inward', name: 'Inward', icon: 'fa-truck-loading' },
    { id: 'operations', name: 'Operations', icon: 'fa-cogs' },
    { id: 'inspection', name: 'Inspection', icon: 'fa-clipboard-check' },
  ];
  ...
  readonly managementCards: DashCard[] = [
    {
      id: 'receiving',
      title: 'Receiving',
      description: 'Receive raw and packing materials against PO and Payment Slip',
      route: '/store/raw/receiving',
    ...
    },
    {
      ...
      description: 'Generate and print material identification barcodes',
      route: '/store/raw/barcodePriting',
      icon: 'fa-barcode',
      category: 'Operations',
      gradient: G.navy,
    ...
    },
    {
      ...
      description: 'Inspect and record damaged containers or materials',
      route: '/store/raw/damage',
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Store raw hub navigation failed:', card.route, err);
    });
  }
  ...
  onCloseDashboard(): void {
    this.deptNav.goBack(this.route, '/store');
  }
}
