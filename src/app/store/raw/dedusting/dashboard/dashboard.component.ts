...
export class DashboardComponent implements OnInit {
  ...
  getDedustingMaterials() {
    this.service.get('store/raw.php?type=getDedustingMaterials&material_type='+this.material_type).subscribe(response => {
  ...
  view(data) {
    ...
    this.dedusting_details = this.selectedReport['dedusting_details'];
    this.isView = true;
  }
