...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'store_dashboard_category';
  private readonly paletteKey = 'store_dashboard_palette';

  readonly categories: StoreCategory[] = [
    { id: 'inward', name: 'Inward / Outward', icon: 'fa-truck' },
    { id: 'operations', name: 'Operations', icon: 'fa-boxes' },
  ...
  readonly managementCards: DashCard[] = [
    {
      id: 'raw',
      title: 'Raw/Packing Material',
      description: 'Raw and packing material inward',
      route: '/store/raw',
      icon: 'fa-cubes',
    ...
    {
      id: 'material',
      title: 'Outward Material',
      description: 'Material outward records',
      route: '/store/material',
    ...
    },
    {
      id: 'retest',
      title: 'Retest',
      description: 'Material retest processing',
      route: '/store/raw/retest',
      icon: 'fa-sync-alt',
      category: 'Inward / Outward',
      gradient: G.steel,
      categoryId: 'inward',
    },
    {
      id: 'dispensing',
      title: 'Dispensing',
      description: 'Material dispensing',
      route: '/store/dispensing',
      icon: 'fa-flask',
      category: 'Operations',
      gradient: G.navy,
    ...
    },
    {
      ...
      description: 'Material status overview',
      route: '/store/material-status',
      icon: 'fa-chart-bar',
      category: 'Operations',
      gradient: G.teal,
      categoryId: 'operations',
    ...
    },
    {
      id: 'rack',
      title: 'WMS Master',
      description: 'Warehouse rack master',
      route: '/store/rack',
      icon: 'fa-layer-group',
      category: 'Masters',
      gradient: G.copper,
    ...
    //   description: 'Material issue requests',
    //   route: '/store/material-issue-request',
    ...
    // },
    {
      ...
      route: '/store/purchase-requisition',
    ...
    },
    {
      ...
      description: 'Material expiry tracking',
      route: '/store/expiry-management',
  ...
  get currentCategory(): StoreCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Store hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: StoreCategory): string {
    return cat.id;
  }
