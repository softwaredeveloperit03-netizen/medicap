...
export class LogComponent implements OnInit {
  ...
  getChangeControlsDept() {
    this.service.get('store/changecontrol.php?type=getChangeControlsDept&fromdate='+this.fromdate+'&todate='+this.todate).subscribe((response:any) => {
  ...
  download(){
    this.service.open('store/changecontrol.php?type=downloadChangeControlsLog');
  }
}