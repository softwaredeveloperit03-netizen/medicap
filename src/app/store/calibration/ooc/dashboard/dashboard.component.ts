...
export class DashboardComponent implements OnInit {
  ...
  getPendingOOC() {
    this.service.get('store/calibration.php?type=getPendingOOC').subscribe(response => {
  ...
  save(data){
    ...
    this.service.post('store/calibration.php?type=saveOOC',JSON.stringify(temp)).subscribe(response =>{
