...
export class LogComponent implements OnInit {
  ...
  getWeighingMaterials() {
    this.service.get('store/packing.php?type=getWeighingMaterials&material_subtype='+this.material_subtype+'&vendor_name='+this.vendor_name+'&from_date='+this.from_date+'&to_date='+this.to_date).subscribe(response => {
