...
@Component({
  selector: 'app-from-production',
  templateUrl: './from-production.component.html',
  styleUrls: ['./from-production.component.css']
})
export class FromProductionComponent implements OnInit {
  equip;
  ...
  getData() {
    this.service.get('production/product.php?type=from_prod').subscribe(response => {
      this.equip = response;
    });
  }
