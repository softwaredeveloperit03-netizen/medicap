...
export class NewComponent implements OnInit {
  ...
  getDepartmentSections(){
    this.service.get('common.php?type=getSections').subscribe(response => {
  ...
  saveMaintenanceNote(data){
    ...
    //   return;
    // }s
    this.service.post('engineering/maintenance.php?type=saveMaintenance',JSON.stringify(data.value)).subscribe(response => {
