...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'security_dashboard_category';
  private readonly paletteKey = 'security_dashboard_palette';

  readonly categories: SecurityCategory[] = [
    { id: 'entry', name: 'Vehicle Entry', icon: 'fa-truck' },
    { id: 'inward', name: 'Material Inward', icon: 'fa-sign-in-alt' },
    { id: 'outward', name: 'Material Outward', icon: 'fa-sign-out-alt' },
    { id: 'attendance', name: 'Attendance', icon: 'fa-users' },
  ];
  ...
  readonly managementCards: DashCard[] = [
    ...
    },
    {
      ...
      route: '/security/materialoutword',
    ...
    },
    {
      ...
      description: 'Outward gate pass',
      route: '/security/outward',
      icon: 'fa-dolly',
      category: 'Material Outward',
      gradient: G.amber,
      categoryId: 'outward',
    },
    {
      id: 'entry',
      title: 'Vehicle Entry',
      description: 'Vehicle entry and exit',
      route: '/security/entry',
      icon: 'fa-truck',
      category: 'Entry',
      gradient: G.steel,
      categoryId: 'entry',
    ...
    {
      id: 'attendence',
      title: 'Emp. Entry / Exit',
      description: 'Employee entry and exit',
      route: '/security/attendence',
      icon: 'fa-user-check',
      category: 'Attendance',
      gradient: G.navy,
  ...
  get currentCategory(): SecurityCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Security hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: SecurityCategory): string {
    return cat.id;
  }
