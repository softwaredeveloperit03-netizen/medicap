...
export class PoapprovalComponent implements OnInit {
  ...
  getAllPendingPO() {
    this.service.get('purchase/po/raw.php?type=getAllPendingPOForDirectorApproval&po_type=' + this.po_type).subscribe((response) => {
  ...
  updatePO(status) {
    ...
    this.service.post('purchase/po/raw.php?type=directorApproval', JSON.stringify(temp) ).subscribe((response) => {
