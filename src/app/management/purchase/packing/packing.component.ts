...
export class PackingComponent implements OnInit {
    ...
    ngOnInit(): void {
      ...
      getdata() {
        ...
        this.service.get('purchase/po/raw.php?type=getPackinglog').subscribe(response => {
    ...
    download(){
      this.service.open('headquarter.php?type=getPackingPurchaseOrders&from_date='+this.from_date+'&to_date='+this.to_date)
    }
