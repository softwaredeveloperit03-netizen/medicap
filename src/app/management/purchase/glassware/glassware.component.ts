...
export class GlasswareComponent implements OnInit {
    ...
    getdata() {
      ...
      this.service.get('purchase/po/raw.php?type=getGlasswarelog').subscribe(response => {
    ...
    view(index){  
      ...
      download(){
        this.service.open('headquarter.php?type=getGlasswarePurchaseOrders&from_date='+this.from_date+'&to_date='+this.to_date)
      }
