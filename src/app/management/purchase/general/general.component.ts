...
export class GeneralComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    getdata() {
      ...
      this.service.get('purchase/po/raw.php?type=getGenerallog').subscribe(response => {
        this.results = response;
      
      });
    }
  // viewOrder(){
  //   this.service.get('headquarter.php?type=getGeneralPurchaseOrders&from_date='+this.from_date+'&to_date='+this.to_date).subscribe(response=>{
  //     this.results=response;
  //   });
  // }
  ...
  download(){
    this.service.open('headquarter.php?type=getGeneralPurchaseOrders&from_date='+this.from_date+'&to_date='+this.to_date)
  }
