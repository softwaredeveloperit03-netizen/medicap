...
@Component({
  selector: 'app-attenance',
  templateUrl: './attenance.component.html',
  styleUrls: ['./attenance.component.css'],
})
export class AttenanceComponent implements OnInit {
  // employees;
  // departments;
  // department_name = '';
  // results;
  ...
  //   this.service
  //     .get(
  //       'hr/attendance.php?type=getMonthlyAttendance&department_name=' +
