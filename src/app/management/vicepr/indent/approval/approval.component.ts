...
export class ApprovalComponent implements OnInit {
  ...
  getPendingIndends() {
    this.service.get('purchase/indent.php?type=getIndentForApprovalPlantHead&status=TO_VP').subscribe((response: any) => {
  ...
  approveIndend(status) {
    ...
    this.service.post('purchase/indent.php?type=approveIndentFromVp&status=' + status, JSON.stringify(temp)).subscribe(response => {
