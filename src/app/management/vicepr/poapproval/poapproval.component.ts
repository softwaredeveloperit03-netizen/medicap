...
export class PoapprovalComponent implements OnInit {
  ...
  getAllPendingPO() {
    this.service.get('purchase/po/raw.php?type=getAllPendingPOForCFOApproval&po_type=' + this.po_type).subscribe((response) => {
  ...
  updatePO(status) {
    ...
    this.service.post('purchase/po/raw.php?type=cfoApproval', JSON.stringify(temp) ).subscribe((response) => {
