...
@Component({
  selector: 'app-oinitiate',
  templateUrl: './oinitiate.component.html',
  styleUrls: ['./oinitiate.component.css']
})
export class OinitiateComponent implements OnInit {
  ...
  saveData(data){
    ...
    this.service.post('qms/ccpermanant.php?type=OinitiateCC',uploadData).subscribe(response=>{
