...
export class EvaluationComponent implements OnInit {
  ...
  getPendingQuestionaries() {
    this.service.get('training.php?type=getPendingQMSQuestionaries').subscribe(response => {
      this.results = response;
    });
  } 

  getCompletedQuestionaries() {
    this.service.get('training.php?type=getCompletedQMSQuestionaries').subscribe(response => {
