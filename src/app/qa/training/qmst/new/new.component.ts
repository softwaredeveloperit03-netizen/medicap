...
export class NewComponent implements OnInit {
  ...
  getTrainingNeeds() {
    this.service
      .get('training.php?type=getTrainingNeedsforQMS')
      .subscribe((response) => {
  ...
  downloadreport() {
    this.service.open('pdf1/training.php?type=qmstraininglog');
  }
  downloadview(value) {
    this.service.open(
      'pdf1/training.php?type=qmstrainingneedsview&id=' + value
    );
  }
  // -----------------------------------------12th july------------------------------------------//
