...
@Component({
  selector: 'app-training-attendance-log',
  templateUrl: './training-attendance-log.component.html',
  styleUrls: ['./training-attendance-log.component.css']
})
export class TrainingAttendanceLogComponent implements OnInit {
