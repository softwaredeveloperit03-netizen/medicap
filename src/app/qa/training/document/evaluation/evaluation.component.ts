...
export class EvaluationComponent implements OnInit {
  ...
  getPendingQuestionaries() {
    this.service.get('training.php?type=getPendingDocQuestionaries').subscribe(response => {
      this.results = response;
    });
  }

  getCompletedQuestionaries() {
    this.service.get('training.php?type=getCompletedDocQuestionaries').subscribe(response => {
