...
@Component({
  selector: 'app-identified-need',
  templateUrl: './identified-need.component.html',
  styleUrls: ['./identified-need.component.css']
})
export class IdentifiedNeedComponent implements OnInit {
  ...
  getScheduleLog() {
    this.service.get('training.php?type=getScheduleLog').subscribe(response => {
      this.results = response;
    });
  }

  getTrainings() {
    this.service.get('training.php?type=getPendingTrainings').subscribe(response => {
