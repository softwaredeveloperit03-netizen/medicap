...
export class DashboardComponent implements OnInit {
  cards: QcDeptCard[] = [
    { id: 'product-new', title: 'New Product', route: 'product/new', icon: 'fa-th-large', category: 'Modules', gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' },
    { id: 'product-approve', title: 'Products for Approval', route: 'product/approve', icon: 'fa-th-large', category: 'Modules', gradient: 'linear-gradient(135deg, #4facfe 0%, #764ba2 100%)' },
    { id: 'product-mrphistory', title: 'MRP Change History', route: 'product/mrphistory', icon: 'fa-th-large', category: 'Modules', gradient: 'linear-gradient(135deg, #43e97b 0%, #764ba2 100%)' },
  ];
  ...
  getProductsLog() {
    this.service.get('qa/product.php?type=getProductsLog&c='+this.dosage_form+'&grade='+ this.grade + '&status='+this.status+'&generic_name='+this.generic_name).subscribe(response => {
