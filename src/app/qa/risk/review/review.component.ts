...
export class ReviewComponent implements OnInit {
  ...
  getPendingRiskReviews() {
    this.service.get('qa/risk.php?type=getPendingRiskReviews').subscribe(response => {
  ...
  save(data) {
    ...
    this.service.post('qa/risk.php?type=saveRiskReview', JSON.stringify(temp)).subscribe(response => {
