...
@Component({
  selector: 'app-taskdept',
  templateUrl: './taskdept.component.html',
  styleUrls: ['./taskdept.component.css'],
})
export class TaskdeptComponent implements OnInit {
  ...
  getInprocessCapa() {
    this.service
      .get(
        'qms/capa2.php?type=getCAPADeptTask&deptName=' +
  ...
  formData.append('deptName', localStorage.getItem('department'));
    ...
    this.service
      .post(
        'qms/capa2.php?type=CapaDeptComment'  , formData
