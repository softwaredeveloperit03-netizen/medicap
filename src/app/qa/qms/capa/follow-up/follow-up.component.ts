...
export class FollowUpComponent implements OnInit {
  ...
  getInprocessCapa() {
    this.service
      .get(
        'qms/capa2.php?type=getCapaDeptComment&deptName=' +
  ...
  update(data) {
    ...
    formData.append('followUpdeptTask', this.followUpdeptTask);
    formData.append('followUpcapaImplemented', this.followUpcapaImplemented);
    formData.append('followUpcomments', this.followUpcomments);
    formData.append('followUpcompletedInTime', this.followUpcompletedInTime);
    formData.append(
      'followUpimplementationDate',
    ...
    this.service
      .post('qms/capa2.php?type=followUpCapa', formData)
      .subscribe((response) => {
