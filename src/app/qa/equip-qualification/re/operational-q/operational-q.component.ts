...
@Component({
  selector: 'app-operational-q',
  templateUrl: './operational-q.component.html',
  styleUrls: ['./operational-q.component.css'],
})
export class OperationalQComponent implements OnInit {
  constructor() {}
