...
@Component({
  selector: 'app-installation-q',
  templateUrl: './installation-q.component.html',
  styleUrls: ['./installation-q.component.css'],
})
export class InstallationQComponent implements OnInit {
  constructor() {}
