...
import { UtilitiesQComponent } from './utilities-q/utilities-q.component';
import { OperationInputComponent } from './operation-input/operation-input.component';
import { FinalReportComponent } from './final-report/final-report.component';
import { InitialPqComponent } from './initial-pq/initial-pq.component';
...
const routes: Routes = [
  ...
  },
  {
    path: 'performace',
    loadChildren: () =>
      import('./performace/performace.module').then((m) => m.PerformaceModule),
    data: { preload: false },
  },
  {
    path: 'report',
  ...
  { path: 'utilities', component: UtilitiesQComponent },
  { path: 'operation', component: OperationInputComponent },
  { path: 'final-report', component: FinalReportComponent },
  { path: 'InitialPq', component: InitialPqComponent },
];
