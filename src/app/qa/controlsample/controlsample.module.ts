...
import { RequestComponent } from './review/request/request.component';
...
const routes: Routes = [
  ...
  { path: 'sample', component: RequestComponent},
  ...
  { path: 'masters', loadChildren: () => import('./masters/masters.module').then(m=>m.MastersModule), data: {preload: false}},
];

@NgModule({
  declarations: [DashboardComponent, NewComponent, ApprovalComponent, LogComponent, ExpiredComponent, DistroyComponent, ReviewComponent,NewReviewComponent, RequestComponent],
  imports: [
