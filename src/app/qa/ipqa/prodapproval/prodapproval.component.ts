...
@Component({
  selector: 'app-prodapproval',
  templateUrl: './prodapproval.component.html',
  styleUrls: ['./prodapproval.component.css']
})
export class ProdapprovalComponent implements OnInit {
  ...
  updateDispensingStatus(status) {
    ...
    let temp = {};
    this.service.post('store/dispensing.php?type=update_prod_dispence_status&id=' + this.selectedMaterial['dispence_id'] + '&status=' + status, null).subscribe(response => {
