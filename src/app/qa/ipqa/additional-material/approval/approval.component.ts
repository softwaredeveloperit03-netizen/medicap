...
export class ApprovalComponent implements OnInit {
  ...
  approve() {
    ...
    if (this.selectedResult['qty'] == null) {
      ...
      this.service.post('production/additional_material.php?type=approve_by_qa&id=' + this.selectedResult['id'], JSON.stringify(this.selectedResult)).subscribe(response => {
