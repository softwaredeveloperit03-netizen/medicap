...
@Component({
  selector: 'app-qual-cert',
  templateUrl: './qual-cert.component.html',
  styleUrls: ['./qual-cert.component.css']
})
export class QualCertComponent implements OnInit {
  ...
  save(data) {
    ...
    this.service.post('qa/all2.php?type=save_qualification', uploadData).subscribe(response => {
