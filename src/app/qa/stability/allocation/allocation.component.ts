...
export class AllocationComponent implements OnInit {
  ...
  allocateInterval(data) {
    ...
    this.condition['unit'] = this.selectedStability['unit'];
    conditions[this.selectedCondition] = this.condition;
    this.selectedStability['conditions'] = conditions;
    

    this.service.post('stability.php?type=allocateIntervalSamplingPerson&stability_no=' +
       this.selectedStability['id'] + '&condition=' + this.selectedCondition  + '&unit=' + this.selectedStability['unit'] + 
       '&interval=' + this.selectedInterval + '&product_code=' + 
       this.selectedStability['product_code'] + '&specification_no=' + 
  ...
  download() {
    this.service.open('stability.php?type=SampleWithdrawlPdf');
  }
}
