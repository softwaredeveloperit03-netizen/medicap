...
@Component({
  selector: 'app-type-software',
  templateUrl: './type-software.component.html',
  styleUrls: ['./type-software.component.css']
})
export class TypeSoftwareComponent implements OnInit {
  results: any;
  ...
  change_related = [
    ...
    { id: 8, particular: 'Batch Packing Card/Record', check: '' },
