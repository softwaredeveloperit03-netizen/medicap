...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'accounts_dashboard_category';
  private readonly paletteKey = 'accounts_dashboard_palette';

  readonly categories: AccountsCategory[] = [
    { id: 'accounts', name: 'Accounts', icon: 'fa-calculator' },
  ];
  ...
  readonly managementCards: DashCard[] = [
    {
      ...
      description: 'Material approval workflow',
      route: '/accounts/materialApproval',
    ...
    },
    {
      id: 'poPayLog',
      title: 'PO Log',
      description: 'Purchase order payment log',
      route: '/accounts/poPayLog',
      icon: 'fa-clipboard-check',
      category: 'Accounts',
      gradient: G.blue,
      categoryId: 'accounts',
    ...
    {
      id: 'fgProductApproval',
      title: 'Finished Product Approval',
      description: 'Finished product approval',
      route: '/accounts/fgProductApproval',
      icon: 'fa-clipboard-check',
      category: 'Accounts',
      gradient: G.teal,
      categoryId: 'accounts',
    ...
    {
      id: 'prc',
      title: 'Purchase Rate Contract',
      description: 'Purchase rate contracts',
      route: '/accounts/prc',
  ...
  get currentCategory(): AccountsCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Accounts hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: AccountsCategory): string {
    return cat.id;
  }
