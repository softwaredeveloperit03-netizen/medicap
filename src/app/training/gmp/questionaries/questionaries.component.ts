...
export class QuestionariesComponent implements OnInit {
  ...
  getPendingQuestionaries() {
    this.service.get('training.php?type=getQuestionnierForDept&training_category=cGMP Training&dept_name=' + localStorage.getItem('department')).subscribe(response => {
