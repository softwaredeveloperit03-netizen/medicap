...
export class AttendanceComponent implements OnInit {
  ...
  getAttendanceLog() {
    this.service.get('training.php?type=getAttendanceLogForDept&training_category='+ this.training_category+'&dept_name=' + localStorage.getItem('department')).subscribe(response => {
  ...
  getPendingScheduleTrainings() {
    this.service.get('training.php?type=getPendingAttendanceTrainingsForSep&training_category='+ this.training_category+'&dept_name=' + localStorage.getItem('department')).subscribe(response => {
