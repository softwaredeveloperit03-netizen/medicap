...
export class QuestionariesComponent implements OnInit {
  ...
  getPendingQuestionaries() {
    this.service.get('training.php?type=getPendingAdminQuestionaries').subscribe(response => {
      this.results = response;
    });
  }

  getCompletedQuestionaries() {
    this.service.get('training.php?type=getCompletedQuestionariesAdmin').subscribe(response => {
