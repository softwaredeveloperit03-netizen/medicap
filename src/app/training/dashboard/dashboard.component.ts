...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'training_dashboard_category';
  private readonly paletteKey = 'training_dashboard_palette';

  readonly categories: TrainingCategory[] = [
    { id: 'training', name: 'Training', icon: 'fa-graduation-cap' },
  ];

  readonly managementCards: DashCard[] = [
    { id: 'question', title: 'Questionnaire', description: 'Training questionnaire', route: '/training/question', icon: 'fa-clipboard-check', category: 'Training', gradient: G.indigo, categoryId: 'training' },
    { id: 'induction', title: 'Induction Training', description: 'Induction training', route: '/training/Induction', icon: 'fa-file-alt', category: 'Training', gradient: G.blue, categoryId: 'training' },
    { id: 'onjob', title: 'On Job Training', description: 'On job training', route: '/training/onjob', icon: 'fa-bullhorn', category: 'Training', gradient: G.teal, categoryId: 'training' },
    { id: 'gmp', title: 'cGMP Trainings', description: 'cGMP trainings', route: '/training/gmp', icon: 'fa-bullhorn', category: 'Training', gradient: G.amber, categoryId: 'training' },
    { id: 'trainings', title: 'Other Trainings', description: 'Other trainings', route: '/training/trainings', icon: 'fa-bullhorn', category: 'Training', gradient: G.steel, categoryId: 'training' },
    { id: 'training-retraining-awaiting', title: 'Re - Training', description: 'Retraining', route: '/training/retraining', icon: 'fa-bullhorn', category: 'Training', gradient: G.navy, categoryId: 'training' },
  ];
  ...
  get currentCategory(): TrainingCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Training hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: TrainingCategory): string {
    return cat.id;
  }
