...
export class RejectComponent implements OnInit {
  ...
  getScheduleLog() {
    this.service.get('training.php?type=getOJTScheduleLogForDeptHoldRej&training_category=Level 3 ( On The Job Training )&dept_name=' + localStorage.getItem('department')+'&status=Rejected').subscribe(response => {
