...
export class IndividualComponent implements OnInit {
  ...
  getScheduleLog() {
    this.service.get('training.php?type=getScheduleLogAdmin').subscribe(response => {
      this.results = response;
    });
  }

  getTrainings() {
    this.service.get('training.php?type=getPendingTrainingsAdmin').subscribe(response => {
