...
export class DashboardComponent implements OnInit {
  ...
  sidebarTitle = 'Transporter Modules';
  sectionLabel = 'Transporter Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'admin_transporter_dashboard_category';
  private readonly paletteKey = 'admin_transporter_dashboard_palette';

  readonly categories: AdminHubCategory[] = [
    { id: 'transporter', name: 'Transporter', icon: 'fa-truck' }
  ];
  ...
  readonly managementCards: DashCard[] = [
    {
      ...
      description: 'View transporter records',
      route: '/admin/transporter/log',
      icon: 'fa-list',
    ...
    },
    {
      ...
      description: 'Create a new transporter registration',
      route: '/admin/transporter/new',
      icon: 'fa-plus-circle',
      category: 'Transporter',
      gradient: G.teal,
      categoryId: 'transporter',
    ...
    },
    {
      ...
      description: 'Approve pending transporter forms',
      route: '/admin/transporter/approval',
