...
export class DashboardComponent implements OnInit {
  pageTitle = 'Laundry and Gowning';
  sidebarTitle = 'Laundry Modules';
  sectionLabel = 'Laundry Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'admin_laundry_dashboard_category';
  private readonly paletteKey = 'admin_laundry_dashboard_palette';
  ...
  readonly managementCards: DashCard[] = [
    {
      id: 'laundry',
      title: 'Requisition for New Gowns',
      description: 'Requisition for new gowns',
      route: '/admin/laundry/laundry',
      icon: 'fa-tshirt',
      category: 'Laundry',
      gradient: G.indigo,
      categoryId: 'laundry',
    ...
    {
      id: 'Cleaning',
      title: 'Receive and Cleaning Record',
      description: 'Receive and cleaning records',
      route: '/admin/laundry/Cleaning',
      icon: 'fa-file-alt',
      category: 'Laundry',
      gradient: G.blue,
      categoryId: 'laundry',
    ...
    {
      id: 'gowns-distribution',
      title: 'Gowns Distribution',
      description: 'Distribution of gowns',
      route: '/admin/laundry/gowns-distribution',
      icon: 'fa-tshirt',
      category: 'Laundry',
      gradient: G.teal,
      categoryId: 'laundry',
    ...
    {
      id: 'laundry-registrayion',
      title: 'New Laundry Registration',
      description: 'Register new laundry',
      route: '/admin/laundry/laundry-registrayion',
    ...
    {
      id: 'gawn-testing',
      title: 'Gown / Apron Test Report',
      description: 'Gown and apron test report',
      route: '/admin/laundry/gawn-testing',
      icon: 'fa-vial',
      category: 'Laundry',
      gradient: G.steel,
      categoryId: 'laundry',
