...
getDetails()
{
  this.service.get('admin/facility.php?type=get_electrical').subscribe((response:any) => {
    this.data = response;
...
onFileChanged3(event) {
  ...
  save(data) {
    ...
    this.service.post('admin/facility.php?type=save_electronics', uploadData).subscribe(response => {
