...
export class AnnouncementComponent implements OnInit {
  ...
  getScheduleLog() {
    this.service.get('training.php?type=getScheduleLogpurchase').subscribe(response => {
      this.results = response;
    });
  }

  getTrainings() {
    this.service.get('training.php?type=getPendingTrainingspurchase').subscribe(response => {
