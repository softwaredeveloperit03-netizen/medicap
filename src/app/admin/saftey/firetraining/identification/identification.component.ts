...
export class IdentificationComponent implements OnInit {
  ...
  getTrainingNeeds() {
    this.service
      .get('training.php?type=getTrainingNeedsPurchase')
      .subscribe((response) => {
  ...
  saveTrainingNeeds(data) {
    ...
    this.service
      .post('training.php?type=saveTrainingNeedsdept', JSON.stringify(data))
      .subscribe((response) => {
  ...
  downloadreport() {
    this.service.open('pdf1/training.php?type=traininglogdm');
  }
  downloadview(value) {
