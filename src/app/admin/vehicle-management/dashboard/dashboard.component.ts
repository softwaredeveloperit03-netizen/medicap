...
export class DashboardComponent implements OnInit {
  ...
  sidebarTitle = 'Vehicle Modules';
  sectionLabel = 'Vehicle Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'admin_vehicle_dashboard_category';
  private readonly paletteKey = 'admin_vehicle_dashboard_palette';
  ...
  readonly managementCards: DashCard[] = [
    {
      ...
      description: 'View vehicle register log',
      route: '/admin/vehicle-management/register',
      icon: 'fa-list',
      category: 'Vehicle',
      gradient: G.blue,
      categoryId: 'vehicle',
    },
    {
      ...
      route: '/admin/vehicle-management/new',
      icon: 'fa-plus-circle',
      category: 'Vehicle',
      gradient: G.teal,
      categoryId: 'vehicle',
