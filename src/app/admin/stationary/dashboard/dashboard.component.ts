...
export class DashboardComponent implements OnInit {
  pageTitle = 'Stationary Inventory';
  sidebarTitle = 'Stationary Modules';
  sectionLabel = 'Stationary Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'admin_stationary_dashboard_category';
  private readonly paletteKey = 'admin_stationary_dashboard_palette';

  readonly categories: AdminHubCategory[] = [
    { id: 'stationary', name: 'Stationary', icon: 'fa-pen' }
  ];

  readonly managementCards: DashCard[] = [
    {
      id: 'stationary',
      title: 'Requisitions for Stationary',
      description: 'Raise and track stationary requisitions',
      route: '/admin/stationary/stationary',
      icon: 'fa-pen',
      category: 'Stationary',
      gradient: G.indigo,
    ...
    },
    {
      ...
      description: 'Record and view consumption',
      route: '/admin/stationary/consumption',
      icon: 'fa-file-alt',
      category: 'Stationary',
      gradient: G.blue,
      categoryId: 'stationary',
    },
    {
      ...
      description: 'Maintain stock register',
      route: '/admin/stationary/stcok-register',
