...
export class DashboardComponent implements OnInit {
  pageTitle = 'First Aid';
  sidebarTitle = 'First Aid Modules';
  sectionLabel = 'First Aid Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'admin_firstaid_dashboard_category';
  private readonly paletteKey = 'admin_firstaid_dashboard_palette';

  readonly categories: AdminHubCategory[] = [
    { id: 'firstaid', name: 'First Aid', icon: 'fa-first-aid' }
  ];

  readonly managementCards: DashCard[] = [
    {
      id: 'requisition',
      title: 'First Aid Material Requisition',
      description: 'Raise first aid material requests',
      route: '/admin/first-aid/requisition',
      icon: 'fa-first-aid',
      category: 'First Aid',
      gradient: G.indigo,
      categoryId: 'firstaid',
    ...
    {
      id: 'stock-register',
      title: 'First Aid Stock Register',
      description: 'Maintain first aid stock',
      route: '/admin/first-aid/stock-register',
    ...
    },
    {
      ...
      description: 'First aid procedures and guidelines',
      route: '/admin/first-aid/procedure',
    ...
    {
      id: 'usage-record',
      title: 'First Aid Usage Record',
      description: 'Record first aid usage',
      route: '/admin/first-aid/usage-record',
