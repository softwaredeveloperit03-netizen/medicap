...
export class DashboardComponent implements OnInit {
  pageTitle = 'Housekeeping Material';
  sidebarTitle = 'Housekeeping Modules';
  sectionLabel = 'Housekeeping Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'admin_housekeeping_dashboard_category';
  private readonly paletteKey = 'admin_housekeeping_dashboard_palette';

  readonly categories: AdminHubCategory[] = [
    { id: 'housekeeping', name: 'Housekeeping', icon: 'fa-broom' }
  ];

  readonly managementCards: DashCard[] = [
    {
      id: 'material',
      title: 'Requisition for Housekeeping Material',
      description: 'Raise requisition for housekeeping material',
      route: '/admin/housekeeping/material',
      icon: 'fa-box-open',
    ...
    {
      id: 'issuance',
      title: 'Issuance of Material',
      description: 'Issue housekeeping material',
      route: '/admin/housekeeping/issuance',
    ...
    {
      id: 'disinfect',
      title: 'Disinfectant Preparation',
      description: 'Disinfectant preparation records',
      route: '/admin/housekeeping/disinfect',
      icon: 'fa-flask',
      category: 'Housekeeping',
      gradient: G.teal,
      categoryId: 'housekeeping',
    ...
    },
    {
      ...
      description: 'Destruction and disposal record',
      route: '/admin/housekeeping/distruction',
      icon: 'fa-trash-alt',
      category: 'Housekeeping',
      gradient: G.amber,
      categoryId: 'housekeeping',
    ...
    {
      id: 'daily',
      title: 'Housekeeping Record',
      description: 'Daily housekeeping records',
      route: '/admin/housekeeping/daily',
