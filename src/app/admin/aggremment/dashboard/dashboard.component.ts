...
export class DashboardComponent implements OnInit {
  pageTitle = 'Agreement';
  sidebarTitle = 'Agreement Modules';
  sectionLabel = 'Agreement Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'admin_aggremment_dashboard_category';
  private readonly paletteKey = 'admin_aggremment_dashboard_palette';

  readonly categories: AdminHubCategory[] = [
    { id: 'agreement', name: 'Agreement', icon: 'fa-file-contract' }
  ];
  ...
  readonly managementCards: DashCard[] = [
    {
      ...
      route: '/admin/aggremment/contact',
    ...
    },
    {
      ...
      description: 'Employee agreements and NDA',
      route: '/admin/aggremment/employee',
      icon: 'fa-user-check',
      category: 'Agreement',
      gradient: G.blue,
      categoryId: 'agreement',
    },
    {
      ...
      description: 'Rent and lease agreements',
      route: '/admin/aggremment/rentagreement',
      icon: 'fa-home',
      category: 'Agreement',
      gradient: G.teal,
      categoryId: 'agreement',
