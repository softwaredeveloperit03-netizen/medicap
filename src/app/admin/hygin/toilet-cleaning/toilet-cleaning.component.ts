...
@Component({
  selector: 'app-toilet-cleaning',
  templateUrl: './toilet-cleaning.component.html',
  styleUrls: ['./toilet-cleaning.component.css']
})
export class ToiletCleaningComponent implements OnInit {
  ...
  save(data) {
    ...
    let temp = data.value;
      ...
      this.service.post('admin/housekeeping.php?type=toiletcleandata', JSON.stringify(temp)).subscribe(response => {
