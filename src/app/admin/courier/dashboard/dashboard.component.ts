...
export class DashboardComponent implements OnInit {
  pageTitle = 'Courier Register';
  sidebarTitle = 'Courier Modules';
  sectionLabel = 'Courier Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'admin_courier_dashboard_category';
  private readonly paletteKey = 'admin_courier_dashboard_palette';

  readonly categories: AdminHubCategory[] = [
    { id: 'courier', name: 'Courier', icon: 'fa-shipping-fast' }
  ];
  ...
  readonly managementCards: DashCard[] = [
    {
      ...
      description: 'Register incoming courier and parcels',
      route: '/admin/courier/incoming',
      icon: 'fa-sign-in-alt',
      category: 'Courier',
      gradient: G.indigo,
      categoryId: 'courier',
    },
    {
      ...
      description: 'Register outgoing courier and dispatch',
      route: '/admin/courier/outgoing',
