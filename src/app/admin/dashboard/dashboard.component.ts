...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'admin_dashboard_category';
  private readonly paletteKey = 'admin_dashboard_palette';

  readonly categories: AdminCategory[] = [
    { id: 'admin', name: 'Admin', icon: 'fa-user-shield' },
    { id: 'facilities', name: 'Facilities', icon: 'fa-building' },
    { id: 'transport', name: 'Transport', icon: 'fa-truck' },
    { id: 'other', name: 'Other', icon: 'fa-folder-open' },
  ];

  readonly managementCards: DashCard[] = [
    { id: 'aggremment', title: 'Agreement', description: 'Manage agreements and contracts', route: '/admin/aggremment', icon: 'fa-file-signature', category: 'Admin', gradient: G.indigo, categoryId: 'admin' },
    { id: 'stationary', title: 'Stationary Inventory', description: 'Requisitions, consumption and stock', route: '/admin/stationary', icon: 'fa-pen', category: 'Admin', gradient: G.blue, categoryId: 'admin' },
    { id: 'housekeeping', title: 'Housekeeping Material', description: 'Material requisition and issuance', route: '/admin/housekeeping', icon: 'fa-broom', category: 'Facilities', gradient: G.teal, categoryId: 'facilities' },
    { id: 'gardev', title: 'Garden Management', description: 'Garden and landscape maintenance', route: '/admin/gardev', icon: 'fa-tree', category: 'Facilities', gradient: G.amber, categoryId: 'facilities' },
    { id: 'laundry', title: 'Laundry & Gowning', description: 'Laundry and gowning records', route: '/admin/laundry', icon: 'fa-tshirt', category: 'Facilities', gradient: G.navy, categoryId: 'facilities' },
    { id: 'favility', title: 'Facility', description: 'Facility management and services', route: '/admin/favility', icon: 'fa-building', category: 'Facilities', gradient: G.steel, categoryId: 'facilities' },
    { id: 'first-aid', title: 'First Aid', description: 'First aid requisition and procedures', route: '/admin/first-aid', icon: 'fa-first-aid', category: 'Facilities', gradient: G.slate, categoryId: 'facilities' },
    { id: 'hygin', title: 'Hygiene', description: 'Hygiene reports and ETP logs', route: '/admin/hygin', icon: 'fa-hand-sparkles', category: 'Facilities', gradient: G.copper, categoryId: 'facilities' },
    { id: 'transporter', title: 'Transport Mgt', description: 'Transporter registration and approval', route: '/admin/transporter', icon: 'fa-truck', category: 'Transport', gradient: G.indigo, categoryId: 'transport' },
    { id: 'vehicle-management', title: 'Vehicle Management', description: 'Vehicle category and fleet details', route: '/admin/vehicle-management', icon: 'fa-car', category: 'Transport', gradient: G.blue, categoryId: 'transport' },
    { id: 'scrap', title: 'Scrap Management', description: 'Scrap vendor, entry and sales', route: '/admin/scrap', icon: 'fa-trash-alt', category: 'Other', gradient: G.teal, categoryId: 'other' },
    { id: 'courier', title: 'Courier Register', description: 'Courier and dispatch register', route: '/admin/courier', icon: 'fa-shipping-fast', category: 'Other', gradient: G.amber, categoryId: 'other' },
    { id: 'assetManagement', title: 'Asset Management', description: 'Track and manage assets', route: '/admin/assetManagement', icon: 'fa-tasks', category: 'Other', gradient: G.navy, categoryId: 'other' },
  ];
  ...
  get currentCategory(): AdminCategory | undefined {
  ...
  trackByCatId(_index: number, cat: AdminCategory): string {
    return cat.id;
  }
