...
export class DashboardComponent implements OnInit {
  ...
  sidebarTitle = 'Asset Modules';
  sectionLabel = 'Asset Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'admin_asset_management_dashboard_category';
  private readonly paletteKey = 'admin_asset_management_dashboard_palette';

  readonly categories: AdminHubCategory[] = [
    { id: 'asset', name: 'Asset', icon: 'fa-boxes' }
  ];
  ...
  readonly managementCards: DashCard[] = [
    {
      id: 'newAsset',
      title: 'New Asset',
      description: 'Add new asset entry',
      route: '/admin/assetManagement/newAsset',
      icon: 'fa-plus-circle',
      category: 'Asset',
      gradient: G.indigo,
      categoryId: 'asset',
    },
    {
      id: 'recordAsset',
      title: 'Asset Records',
      description: 'View and edit asset records',
      route: '/admin/assetManagement/recordAsset',
      icon: 'fa-edit',
      category: 'Asset',
      gradient: G.blue,
      categoryId: 'asset',
    },
    {
      ...
      description: 'Schedule and record maintenance',
      route: '/admin/assetManagement/assetMainantence',
      icon: 'fa-tools',
      category: 'Asset',
      gradient: G.teal,
      categoryId: 'asset',
    ...
    {
      id: 'mainannteceHistory',
      title: 'Maintenance History',
      description: 'View maintenance history',
      route: '/admin/assetManagement/mainannteceHistory',
      icon: 'fa-history',
      category: 'Asset',
      gradient: G.amber,
      categoryId: 'asset',
    ...
    {
      id: 'scrapLog',
      title: 'Asset Scrap Log',
      description: 'Asset scrap and disposal log',
      route: '/admin/assetManagement/scrapLog',
      icon: 'fa-dumpster',
      category: 'Asset',
      gradient: G.steel,
      categoryId: 'asset',
