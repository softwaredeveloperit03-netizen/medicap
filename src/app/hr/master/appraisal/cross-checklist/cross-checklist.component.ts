...
@Component({
  selector: 'app-cross-checklist',
  templateUrl: './cross-checklist.component.html',
  styleUrls: ['./cross-checklist.component.css']
})
export class CrossChecklistComponent implements OnInit {
