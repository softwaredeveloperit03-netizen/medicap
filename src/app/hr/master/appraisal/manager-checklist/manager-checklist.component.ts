...
@Component({
  selector: 'app-manager-checklist',
  templateUrl: './manager-checklist.component.html',
  styleUrls: ['./manager-checklist.component.css']
})
export class ManagerChecklistComponent implements OnInit {
