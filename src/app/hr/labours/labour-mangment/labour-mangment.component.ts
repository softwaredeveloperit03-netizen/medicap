...
@Component({
  selector: 'app-labour-mangment',
  templateUrl: './labour-mangment.component.html',
  styleUrls: ['./labour-mangment.component.css']
})
export class LabourMangmentComponent implements OnInit {
