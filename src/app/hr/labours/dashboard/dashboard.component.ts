...
export class DashboardComponent implements OnInit {
  ...
  sidebarTitle = 'Labour Modules';
  sectionLabel = 'Labour Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'hr_labours_dashboard_category';
  private readonly paletteKey = 'hr_labours_dashboard_palette';

  readonly categories: HubCategory[] = [
    { id: 'labour', name: 'Labour', icon: 'fa-hard-hat' },
    { id: 'contractor', name: 'Contractor', icon: 'fa-user-tie' },
  ];
  ...
  readonly managementCards: DashCard[] = [
    {
      ...
      description: 'Labour contractor records',
      route: '/hr/labours/labour-contractor',
      icon: 'fa-users',
      category: 'Contractor',
      gradient: G.navy,
    ...
    },
    {
      ...
      description: 'Contractor agreements',
      route: '/hr/labours/contractor-agreement',
    ...
    },
    {
      ...
      description: 'Labour management workspace',
      route: '/hr/labours/labour-management',
      icon: 'fa-sitemap',
      category: 'Labour',
      gradient: G.indigo,
      categoryId: 'labour',
    ...
    //   description: 'Full contractor workspace',
    //   route: '/hr/labours/contractor-management',
    //   icon: 'fa-hard-hat',
    //   category: 'Contractor',
    //   gradient: G.amber,
    //   categoryId: 'contractor',
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Labours hub navigation failed:', card.route, err);
    });
  }
