...
export class EmployeeJoiningComponent implements OnInit {
  ...
  getCandidates() {
    const dept = encodeURIComponent(this.department_name || '');
    const desig = encodeURIComponent(this.designation || '');
    this.service
      .get('hr/candidate.php?type=getPendingJoiningCandidates&department_name=' + dept + '&designation=' + desig)
  ...
  selectCandidate(index) {
    ...
    this.isNewForm = true;
    const dept = this.selectedCandidate['finaldepartment'] || this.department_name;
    this.loadDesignationsForDepartment(dept);
  }
  ...
  getDesignation() {
    this.loadDesignationsForDepartment(this.department_name);
  }
  ...
  saveEmployee(data) {
    ...
    uploadData.append("appointment_type", "from_interview");
    uploadData.append("isAppointment", "Pending");
    ...
    this.service.post('hr/employee.php?type=saveEmployee&', uploadData).subscribe(response => {
      if (response['status'] === 'success') {
        ...
        this.router.navigate(['/hr/joining/employeeJoining']);
      } else {
