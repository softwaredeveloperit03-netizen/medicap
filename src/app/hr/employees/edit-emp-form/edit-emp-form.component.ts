...
@Component({
  selector: 'app-edit-emp-form',
  templateUrl: './edit-emp-form.component.html',
  styleUrls: ['./edit-emp-form.component.css']
})
export class EditEmpFormComponent implements OnInit {
    ...
    downloadSalaryAnnexure() {
      this.service.open('hr/employee.php?type=download_salary_annexure&emp_code=' + this.selectedResult['emp_id']);
    }
    download() {
