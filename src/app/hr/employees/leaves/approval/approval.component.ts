...
export class ApprovalComponent implements OnInit {
  ...
  getApprovedLeave() {
    this.service.get('hr/leaveForm.php?type=getApprovedLeave&department_name=' + this.department_name + '&emp_id=' + this.emp_id).subscribe(response => {
  ...
  pending
    ...
    update(status) {
     this.service.post('hr/leaveForm.php?type=updateLeaveForm&status='+status +'&id='+this.selectedResult['id'] 
