...
export class DashboardComponent implements OnInit {
  pageTitle = 'Candidate Medical Checkup';
  sidebarTitle = 'Medical Modules';
  sectionLabel = 'Medical Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'hr_medical_dashboard_category';
  private readonly paletteKey = 'hr_medical_dashboard_palette';

  readonly categories: HubCategory[] = [
    { id: 'medical', name: 'Medical', icon: 'fa-notes-medical' },
  ];
  ...
  readonly managementCards: DashCard[] = [
    {
      ...
      description: 'Add new medical checkup',
      route: '/hr/medical/new',
      icon: 'fa-plus-circle',
      category: 'Medical',
      gradient: G.indigo,
      categoryId: 'medical',
    ...
    },
    {
      id: 'upload',
      title: 'Upload Report',
      description: 'Upload medical report',
      route: '/hr/medical/upload-report',
      icon: 'fa-file-upload',
      category: 'Medical',
      gradient: G.amber,
      categoryId: 'medical',
    ...
    {
      id: 'log',
      title: 'Medical Checkup Log',
      description: 'View checkup log',
      route: '/hr/medical/checkup-log',
    ...
    },
    {
      ...
      description: 'Due medical checkups',
      route: '/hr/medical/checkup-due',
    ...
    {
      id: 'calendar',
      title: 'Medical Checkup Calendar',
      description: 'Medical checkup calendar',
      route: '/hr/medical/employeemed',
    ...
    },
    {
      id: 'physicians',
      title: 'Physicians',
      description: 'Physician records',
      route: '/hr/medical/physicians',
      icon: 'fa-user-md',
      category: 'Medical',
      gradient: G.navy,
      categoryId: 'medical',
    },
    {
      ...
      description: 'Medical reports hub',
      route: '/hr/medical/reports',
  ...
  private visibleCards(): DashCard[] {
    return this.managementCards.filter((card) => {
      if (card.showWhen === 'isuser' && this.isuser !== 'Yes') return false;
      return true;
    });
  }
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Medical hub navigation failed:', card.route, err);
    });
  }
