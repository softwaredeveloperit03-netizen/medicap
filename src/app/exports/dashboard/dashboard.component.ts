...
export interface ExportsCategory {
  id: string;
  name: string;
  icon: string;
}
...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'exports_dashboard_category';
  private readonly paletteKey = 'exports_dashboard_palette';

  readonly categories: ExportsCategory[] = [
    { id: 'exports', name: 'Exports', icon: 'fa-ship' },
  ];

  readonly managementCards: DashCard[] = [
    { id: 'authorization', title: 'New Authorization', description: 'Create new authorization', route: '/Exports/authorization', icon: 'fa-certificate', category: 'Exports', gradient: G.indigo, categoryId: 'exports' },
    { id: 'checking', title: 'Checking', description: 'Checking module', route: '/Exports/checking', icon: 'fa-clipboard-check', category: 'Exports', gradient: G.blue, categoryId: 'exports' },
    { id: 'log', title: 'Log', description: 'Export log', route: '/Exports/log', icon: 'fa-list-alt', category: 'Exports', gradient: G.teal, categoryId: 'exports' },
    { id: 'landed', title: 'Landed', description: 'Landed module', route: '/Exports/landed', icon: 'fa-anchor', category: 'Exports', gradient: G.amber, categoryId: 'exports' },
  ];
  ...
  get currentCategory(): ExportsCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Exports hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: ExportsCategory): string {
    return cat.id;
  }
