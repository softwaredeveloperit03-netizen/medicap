...
export class SamplingAllocationComponent implements OnInit {
  ...
  allocatePerson() {
    this.service.get('qc/water.php?type=allocateSamplingPerson&person=' + this.sampling_person +'&point_no='+this.point_no +'&id=' + this.selectedPlan['id']).subscribe(response => {
