...
export class LogComponent implements OnInit {
  ...
  ngOnInit() {
    this.getMicrobiologyTEstingLog();
  ...
  getMicrobiologyTEstingLog() {
    this.service.get('qc/testing/raw.php?type=getMicrobiologyTEstingLog&material_type='+this.material_type).subscribe(response => {
...
exportToExcel(): void {
  const fileName = 'Microbiology_Testing_Log.xlsx';
  ...
  XLSX.utils.book_append_sheet(wb, ws, 'Microbiology Testing Log');
