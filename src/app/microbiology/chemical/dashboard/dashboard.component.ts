...
export class DashboardComponent implements OnInit {
  cards: QcDeptCard[] = [
    { id: 'microbiology-micromaterial-grn-new', title: 'Inward Goods Recv.', route: 'microbiology/microMaterial/grn/new', icon: 'fa-truck', category: 'Modules', gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' },
    { id: 'microbiology-micromaterial-stock', title: 'Stock Book', route: 'microbiology/microMaterial/stock', icon: 'fa-book', category: 'Modules', gradient: 'linear-gradient(135deg, #4facfe 0%, #764ba2 100%)' },
  ];
