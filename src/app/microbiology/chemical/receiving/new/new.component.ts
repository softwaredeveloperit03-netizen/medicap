...
export class NewComponent implements OnInit {
  ...
  getPendingInwords() {
    this.service.get('qc/chemical.php?type=getPendingReceivings').subscribe(response => {
  ...
  receiveMaterial(data) {
   ...
   this.service.post('qc/chemical.php?type=receiveMaterial&id=' + this.selectedPO['id'], uploadData).subscribe(response => {
