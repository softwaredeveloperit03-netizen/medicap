...
@Component({
  selector: 'app-micropipette',
  templateUrl: './micropipette.component.html',
  styleUrls: ['./micropipette.component.css'],
  providers: [DatePipe],
})
export class MicropipetteComponent implements OnInit {
  i: any;
  flag = false;
  del(arg0: any) {
