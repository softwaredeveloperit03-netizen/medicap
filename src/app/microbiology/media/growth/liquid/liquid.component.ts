...
export class LiquidComponent implements OnInit {
  ...
  getMedia() {
    this.service
      .get(
        'microbiology/media.php?type=getGrowthLiquidMediaLog&from_date=' +
          this.from_date +
          '&to_date=' +
          this.to_date
      )
  ...
  download() {
    this.service.open(
      'microbiology/media.php?type=downloadGrowthLiquidMediaLog&from_date=' +
        this.from_date +
        '&to_date=' +
        this.to_date
    );
  ...
  save(data) {
    ...
    this.service
      .post(
        'microbiology/media.php?type=saveGrowthLiquidMedia',
        JSON.stringify(temp)
      )
      .subscribe((response) => {
