...
export class LogComponent implements OnInit {
  ...
  downloadReport(){
    this.service.open('qc/sampling/packing.php?type=downloadSamplingsLog&material_type=' + this.material_type + '&from_date=' + this.from_date + '&to_date=' + this.to_date + '&status=' + this.status);
  }
  downloadPDF(type){
    // if(type == 'manual'){
    ...
    // }
      ...
      if(type == 'manual'){
      this.service.open('qc/sampling/packing.php?type=downloadSamplingsReport&id=' +this.selectedSampling['id']);
    }else{
      this.service.open('qc/sampling/packing.php?type=downloadSamplingsDigital&id=' +this.selectedSampling['id']);
    }
  }
