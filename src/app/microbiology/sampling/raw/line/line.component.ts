...
export class LineComponent implements OnInit {
  ...
  getPendingLineClearance() {
    this.service.get('qc/sampling/raw.php?type=getPendingLineClearance').subscribe(response => {
  ...
  callforclearance(data) {
    ...
    this.service.post('qc/sampling/raw.php?type=callforclearance', JSON.stringify(this.selectedSampling)).subscribe(response => {
