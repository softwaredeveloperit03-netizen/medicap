...
@Component({
  selector: 'app-bfrreview',
  templateUrl: './bfrreview.component.html',
  styleUrls: ['./bfrreview.component.css']
})
export class BfrreviewComponent implements OnInit {
  isApproval = true;
  ...
  getBatchFormaulsToBeApprove() {
    ...
    this.service
      .get('planning/raw.php?type=get_batch_formula_for_approval_Zuma&status=pending')
      .subscribe((response) => {
  ...
  viewBfrRecord(index) {
    ...
    this.raw_materials = JSON.parse(this.selectedBfr['raw_materials']);
    this.packing_List_All = JSON.parse(this.selectedBfr['packing_materials']);
...
SecondaryPacking=[];
  view(index) {
    ...
    this.PrimaryPacking = this.selectedResult['PrimaryPacking'];
    this.SecondaryPacking = this.selectedResult['SecondaryPacking'];
    this.packing_List_All = JSON.parse(this.selectedResult['packing_materials']);
    console.log('this,packing_List_All :>> ', this.packing_List_All);
    if (this.packing_List_All == null) {
      this.packing_List_All = [];
    }
    this.pack_size = [];
  ...
  updateStatus(status) {
    ...
    this.service
      .post(
        'planning/raw.php?type=update_batch_formula_status_Zuma',
        JSON.stringify(obj)
      )
      .subscribe((response) => {
        if (response['status'] === 'success') {
