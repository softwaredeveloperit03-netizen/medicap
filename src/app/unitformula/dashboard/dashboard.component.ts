...
export interface UnitFormulaCategory {
  id: string;
  name: string;
  icon: string;
}
...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'unitformula_dashboard_category';
  private readonly paletteKey = 'unitformula_dashboard_palette';

  readonly categories: UnitFormulaCategory[] = [
    { id: 'formula', name: 'Formula', icon: 'fa-flask' },
  ];

  readonly managementCards: DashCard[] = [
    { id: 'log', title: 'Unit Formula', description: 'Unit formula log', route: '/unitformula/log', icon: 'fa-th-large', category: 'Formula', gradient: G.blue, categoryId: 'formula' },
    { id: 'checking', title: 'Formula for Checking', description: 'Formulas pending checking', route: '/unitformula/checking', icon: 'fa-th-large', category: 'Formula', gradient: G.teal, categoryId: 'formula' },
    { id: 'approval', title: 'Formula for Approval', description: 'Formulas pending approval', route: '/unitformula/approval', icon: 'fa-th-large', category: 'Formula', gradient: G.amber, categoryId: 'formula' },
  ];
  ...
  get currentCategory(): UnitFormulaCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Unit Formula hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: UnitFormulaCategory): string {
    return cat.id;
  }
