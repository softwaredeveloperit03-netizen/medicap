...
@Component({
  selector: 'app-bfrapproval',
  templateUrl: './bfrapproval.component.html',
  styleUrls: ['./bfrapproval.component.css']
})
export class BfrapprovalComponent implements OnInit {
  isApproval = true;
  ...
  getBatchFormaulsToBeApprove() {
    ...
    this.service
    .get('planning/raw.php?type=get_batch_formula_for_approval_Zuma&status=Review')
    .subscribe((response) => {
