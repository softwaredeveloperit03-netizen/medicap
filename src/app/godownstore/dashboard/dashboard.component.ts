...
export interface GodownCategory {
  id: string;
  name: string;
  icon: string;
}
...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'godownstore_dashboard_category';
  private readonly paletteKey = 'godownstore_dashboard_palette';

  readonly categories: GodownCategory[] = [
    { id: 'modules', name: 'Modules', icon: 'fa-th-large' },
  ];

  readonly managementCards: DashCard[] = [
    { id: 'challan', title: 'Challan Upload', description: 'Upload challan documents', route: '/godownStore/challan', icon: 'fa-file-upload', category: 'Modules', gradient: G.indigo, categoryId: 'modules' },
    { id: 'raw', title: 'Raw Material', description: 'Raw material management', route: '/godownStore/raw', icon: 'fa-cubes', category: 'Modules', gradient: G.blue, categoryId: 'modules' },
    { id: 'packing', title: 'Packing Material', description: 'Packing material management', route: '/godownStore/packing', icon: 'fa-box', category: 'Modules', gradient: G.teal, categoryId: 'modules' },
  ];
  ...
  get currentCategory(): GodownCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Godown Store hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: GodownCategory): string {
    return cat.id;
  }
