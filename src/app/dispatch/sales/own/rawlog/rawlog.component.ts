...
export class RawlogComponent implements OnInit {
  ...
  salesLog(){
    this.service.get('dispatch/sales.php?type=getOrdersLograw&client_code='+this.client_code+'&from_date='+this.from_date+'&to_date='+this.to_date).subscribe(response=>{
