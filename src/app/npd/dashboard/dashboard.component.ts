...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'npd_dashboard_category';
  private readonly paletteKey = 'npd_dashboard_palette';

  readonly categories: NpdCategory[] = [
    { id: 'approvals', name: 'Approvals', icon: 'fa-check-circle' },
    { id: 'feasibility', name: 'Feasibility', icon: 'fa-clipboard-list' },
    { id: 'material', name: 'Material Flow', icon: 'fa-boxes' },
  ];

  readonly managementCards: DashCard[] = [
    {
      id: 'npdApproval',
      title: 'RM/PM Approval',
      description: 'Raw and packing material approval',
      route: '/rnd/master/material/approval?returnUrl=%2Fnpd',
      icon: 'fa-bullhorn',
      category: 'Approvals',
      gradient: G.indigo,
    ...
    },
    {
      id: 'eqnFromBd',
      title: 'Enq. From BD',
      description: 'Enquiry from business development',
      route: '/npd/eqnFromBd',
      icon: 'fa-bullhorn',
      category: 'Feasibility',
      gradient: G.blue,
      categoryId: 'feasibility',
    },
    {
      id: 'fesibilityForm',
      title: 'Project Feasibility',
      description: 'Project feasibility form',
      route: '/npd/fesibilityForm',
    ...
    {
      id: 'fesibilityFormLog',
      title: 'Feasibility Form Log',
      description: 'Feasibility form log records',
      route: '/npd/fesibilityFormLog',
      icon: 'fa-list',
      category: 'Feasibility',
      gradient: G.amber,
      categoryId: 'feasibility',
    ...
    {
      id: 'rndMatREqIssueStatusLog',
      title: 'Material Issue Request From RND',
      description: 'R&D material issue request status',
      route: '/npd/rndMatREqIssueStatusLog',
      icon: 'fa-boxes',
    ...
    {
      id: 'packingMAtDevRequest',
      title: 'PM Dev. Request From RND',
      description: 'Packing material development request',
      route: '/npd/packingMAtDevRequest',
      icon: 'fa-box',
      category: 'Material Flow',
      gradient: G.navy,
      categoryId: 'material',
  ...
  get currentCategory(): NpdCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigate([path], { queryParams }).catch((err) => {
      console.error('NPD hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: NpdCategory): string {
    return cat.id;
  }
