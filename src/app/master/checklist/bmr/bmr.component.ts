...
module: any;
  ...
  getCheckListData(){
    ...
    this.service.get('master/checklist.php?type=getMastercheckList_bmr').subscribe(response => {
...
temp['checklist_heading']=this.checklist_heading;
  ...
  saveChecklist(data) {
    ...
    this.service.post('master/checklist.php?type=SaveMastercheckListBMR', JSON.stringify(temp)).subscribe(response => {
