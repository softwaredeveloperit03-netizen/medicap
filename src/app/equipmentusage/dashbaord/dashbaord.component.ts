...
export class DashbaordComponent implements OnInit {
  ...
  private readonly storageKey = 'equipmentusage_dashboard_category';
  private readonly paletteKey = 'equipmentusage_dashboard_palette';

  readonly categories: EquipmentCategory[] = [
    { id: 'usage', name: 'Usage & Cleaning', icon: 'fa-tools' },
    { id: 'environment', name: 'Environment', icon: 'fa-thermometer-half' },
  ];
  ...
  readonly managementCards: DashCard[] = [
    {
      ...
      route: '/equipmentusage/usage',
      icon: 'fa-tachometer-alt',
      category: 'Usage & Cleaning',
      gradient: G.indigo,
      categoryId: 'usage',
    },
    {
      ...
      route: '/equipmentusage/barcodess',
      icon: 'fa-barcode',
      category: 'Usage & Cleaning',
      gradient: G.blue,
      categoryId: 'usage',
    },
    {
      id: 'checkings',
      title: 'Checkings',
      description: 'Cleaning and usage checking',
      route: '/equipmentusage/checkings',
      icon: 'fa-handshake',
      category: 'Usage & Cleaning',
      gradient: G.teal,
      categoryId: 'usage',
    ...
    },
    {
      ...
      route: '/equipmentusage/temprature',
  ...
  get currentCategory(): EquipmentCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Equipment Usage hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: EquipmentCategory): string {
    return cat.id;
  }
