...
export class OnholdComponent implements OnInit {
   ...
   ngOnInit() {
     this.gerOnHoldGrnReceivingLog();
    }
   
   material_type = 'Raw Material';
   gerOnHoldGrnReceivingLog() {
     this.service.get('qc/sampling/raw.php?type=gerOnHoldGrnReceivingLog&material_type=' + this.material_type).subscribe(response => {
   ...
   updatesampling(status) {
    ...
    const result = confirm("Are you sure you want to release this Sampling Intimation? Once released cannot undo action.");
