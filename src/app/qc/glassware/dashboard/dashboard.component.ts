...
export class DashboardComponent implements OnInit {
  cards: QcDeptCard[] = [
    { id: 'receiving', title: 'Receiving of Glassware', route: 'receiving', icon: 'fa-flask', category: 'Modules', gradient: 'linear-gradient(135deg, #4facfe 0%, #764ba2 100%)' },
    { id: 'stock', title: 'Stock Book', route: 'stock', icon: 'fa-book', category: 'Modules', gradient: 'linear-gradient(135deg, #fa709a 0%, #764ba2 100%)' },
    { id: 'qc-cleaning', title: 'Glassware Cleaning & Usage', route: 'qc/cleaning', icon: 'fa-glass-martini-alt', category: 'Modules', gradient: 'linear-gradient(135deg, #30cfd0 0%, #764ba2 100%)' },
  ];
