...
export class NewComponent implements OnInit {
  ...
  getPendingGRN() {
    this.service.get('qc/glassware.php?type=getPendingGRN').subscribe(response => {
  ...
  prepareGRN() {
    ...
    this.service.post('qc/glassware.php?type=saveGRN', JSON.stringify(temp)).subscribe(response => {
