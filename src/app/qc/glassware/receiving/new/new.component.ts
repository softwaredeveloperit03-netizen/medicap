...
export class NewComponent implements OnInit {
  ...
  getPendingInwords() {
    this.service.get('qc/glassware.php?type=getPendingReceivings').subscribe(response => {
  ...
  receiveMaterial(data) {
   ...
   this.service.post('qc/glassware.php?type=receiveMaterial&id=' + this.selectedPO['id'], uploadData).subscribe(response => {
