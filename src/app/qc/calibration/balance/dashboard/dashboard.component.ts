...
export class DashboardComponent implements OnInit {
  cards: QcDeptCard[] = [
    { id: 'daily', title: 'Daily Verification', route: 'daily', icon: 'fa-calendar-day', category: 'Modules', gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' },
    { id: 'monthly', title: 'Monthly Calibration', route: 'monthly', icon: 'fa-calendar-alt', category: 'Modules', gradient: 'linear-gradient(135deg, #4facfe 0%, #764ba2 100%)' },
    { id: 'ooc', title: 'Out of Calibration', route: 'ooc', icon: 'fa-exclamation-triangle', category: 'Modules', gradient: 'linear-gradient(135deg, #43e97b 0%, #764ba2 100%)' },
  ];
