...
export class DailyComponent implements OnInit {
  ...
  getSECTIONS() {
    this.service
      .get('common.php?type=getSECTIONS&department1=Quality Control')
      .subscribe((response) => {
  ...
  getbal_id(value) {
    this.service
      .get(
        'common.php?type=getbal_id&department1=Quality Control&location=' +
          value
      )
      .subscribe((response) => {
        this.ids = response;
  ...
  get_std_weight(index) {
    ...
    this.service
      .get(
        'master/equipment.php?type=get_std_weight&department1=Quality Control&id=' +
    ...
    this.service
      .get(
        'qc/raw.php?type=get_standard_weights&department1=Quality Control&id=' +
          this.selectedResult['id'] +
          '&equipment_code=' +
          equip_code
      )
  ...
  downloadReport() {
    this.service.open(
      'qc/raw.php?type=downloaddaily&department1=Quality Control&id=' +
        this.selectedResult['id'] +
        '&equipment_code=' +
        this.equipment_id +
        '&location=' +
  ...
  saveCalibration(data) {
    ...
    data.resetForm();
    this.service
      .post('qc/raw.php?type=save_calibration', JSON.stringify(temp))
      .subscribe((response) => {
