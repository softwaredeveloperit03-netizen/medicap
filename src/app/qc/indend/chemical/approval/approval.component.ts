...
export class ApprovalComponent implements OnInit {
  ...
  getCheckedIndends() {
    this.service.get('purchase/indend/chemical.php?type=getCheckedIndends').subscribe(response => {
  ...
  approveIndend(status) {
    ...
    this.service.post('purchase/indend/chemical.php?type=approveIndend&status=' + status, JSON.stringify(this.selectedResult)).subscribe(response => {
