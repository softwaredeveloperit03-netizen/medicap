...
export class NewComponent implements OnInit {
  ...
  getPendingReceivings() {
    this.service.get('qc/standard/receiving.php?type=getPendingReceivings').subscribe(response => {
  ...
  receiveMaterial(data) {
    ...
    temp['batches'] = this.labelList;
    this.service.post('qc/standard/receiving.php?type=receiveStandards&id=' + this.selectedPO['id'], JSON.stringify(temp)).subscribe(response => {
