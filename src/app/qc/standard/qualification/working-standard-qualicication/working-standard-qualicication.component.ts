...
@Component({
  selector: 'app-working-standard-qualicication',
  templateUrl: './working-standard-qualicication.component.html',
  styleUrls: ['./working-standard-qualicication.component.css'],
})
export class WorkingStandardQualicicationComponent implements OnInit {
  isNew = false;
  isView = false;
