...
export class ApprovalComponent implements OnInit {
  ...
  getPendingTestingForms() {
    this.service
      .get(
        'qc/testing/raw.php?type=getRejectedTestingForms_approval_oos&is_rds=' +
          0
      )
      .subscribe((response) => {
  ...
  submitTest(data) {
    ...
    this.service
      .post(
        'qc/testing/raw.php?type=updateTestingStatus_approve_oos&testingID=' +
  ...
  Check() {
    ...
    this.service
      .post(
        'qc/testing/raw.php?type=oos_approved&testing_no=' +
          this.selectedTesting['testing_no'] +
          '&testing_test_id=' +
