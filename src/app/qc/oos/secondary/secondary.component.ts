...
export class SecondaryComponent implements OnInit {
  ...
  getPendingTestingForms() {
    this.service
      .get(
        'qc/testing/raw.php?type=getRejectedTestingForms_secondary_oos&is_rds=' +
          0
      )
      .subscribe((response) => {
  ...
  submitTest(data) {
    ...
    this.service
      .post(
        'qc/testing/raw.php?type=updateTestingStatus_secondary_oos&testingID=' +
  ...
  Check() {
    ...
    this.service
      .post(
        'qc/testing/raw.php?type=oos_check_sec&testing_no=' +
          this.selectedTesting['testing_no'] +
          '&testing_test_id=' +
