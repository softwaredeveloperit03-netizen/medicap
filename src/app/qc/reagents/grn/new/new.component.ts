...
export class NewComponent implements OnInit {
  ...
  getPendingGRN() {
    this.service.get('qc/indicator.php?type=getPendingGRN').subscribe(response => {
  ...
  prepareGRN() {
    ...
    this.service.post('qc/indicator.php?type=saveGRN', JSON.stringify(temp)).subscribe(response => {
