...
export class NewComponent implements OnInit {
  ...
  getPendingWeighingMaterials() {
    this.service.get('qc/indicator.php?type=getPendingWeighingMaterials').subscribe(response => {
  ...
  saveWeighings(data) {
    ...
    this.service.post('qc/indicator.php?type=saveWeighingMaterials', JSON.stringify(temp)).subscribe(response => {
