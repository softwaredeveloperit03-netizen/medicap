...
export class NewComponent implements OnInit {
  ...
  ngOnInit() {
    this.getPendingResetMOA();
  }

  getPendingResetMOA(){
    this.service.get('qc/method.php?type=getPendingRetestMOA').subscribe(response => {
  ...
  saveMOA(data) {
    ...
    this.service.post('qc/moa/retest.php?type=saveMOA', JSON.stringify(specification)).subscribe(response => {
