...
export class DashboardComponent implements OnInit {
  ...
  getPackingControlSamples(){
    this.service.get('qa/controlsample.php?type=getPackingControlSamples&material_type=' + this.material_type + '&from_date=' + this.from_date + '&to_date=' + this.to_date).subscribe(response => {
