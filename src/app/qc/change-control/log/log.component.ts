...
export class LogComponent implements OnInit {
  ...
  getChangeControlsDept() {
    this.service.get('qc/changecontrol.php?type=getChangeControlsDept&fromdate='+this.fromdate+'&todate='+this.todate).subscribe((response:any) => {
  ...
  download(){
    this.service.open('qc/changecontrol.php?type=downloadChangeControlLog');
  }
}