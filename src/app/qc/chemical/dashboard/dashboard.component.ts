...
export class DashboardComponent implements OnInit {
  cards: QcDeptCard[] = [
    { id: 'grn', title: 'Inward Goods Recv.', route: 'grn', icon: 'fa-truck', category: 'Modules', gradient: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)' },
    { id: 'stock', title: 'Stock Book', route: 'stock', icon: 'fa-book', category: 'Modules', gradient: 'linear-gradient(135deg, #4facfe 0%, #764ba2 100%)' },
    { id: 'grn', title: 'Inward Goods Receiving', route: 'grn', icon: 'fa-th-large', category: 'Modules', gradient: 'linear-gradient(135deg, #43e97b 0%, #764ba2 100%)' },
  ];
