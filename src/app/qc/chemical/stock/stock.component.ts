...
export class StockComponent implements OnInit {
  ...
  ngOnInit() {
   ...
   subtypes;
   getgensubtype() {
     this.service.get('master/materialtype.php?type=get_gen_material_subtype&material_type=QC Material').subscribe((response: any) => {
  ...
  generate(material_code,index) {
    ...
    const url = 'https://paperlessgmp.in/php/phpWonder/store/raw.php?type=stock_details_other&material_code='+material_code +'&plant_id='+this.plant_id+ '&token=' + localStorage.getItem('token');
