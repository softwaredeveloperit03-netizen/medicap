...
const routes: Routes = [
  ...
  // Legacy redirects to new Master Specification module
  { path: 'raw', redirectTo: '/master/specification/raw', pathMatch: 'full'},
  ...
  { path: 'water', redirectTo: '/master/specification/water', pathMatch: 'full'},
  { path: 'master', loadChildren: () => import('./master-spec/master-spec.module').then(m=>m.MasterSpecModule), data: {preload: false}},
