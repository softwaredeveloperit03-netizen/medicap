...
export class RevisionViewComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.getTests();
    this.getDosageForms();
    this.getManufacturingProcesses();
  ...
  /*getProducts(dosage) {
    this.service.get('qa.php?type=getProductByDosage&dosage_form=' + dosage).subscribe(response => {
  ...
  */
  ...
  getSpecificationRevision() {
    this.service.get('qc/specification/inprocess.php?type=getPendingRevisions').subscribe(response => {
 ...
 save(data) {
    ...
    this.service.post('qc/specification/inprocess.php?type=saveEditSpecification', JSON.stringify(this.selectedSpec)).subscribe(response => {
      if(response['status'] === 'success') {
        this.getSpecificationRevision();
        alertify.success("Data saved Successfully");
       this.router.navigate(['/specifications/inprocess/revision/']);
      } else {
