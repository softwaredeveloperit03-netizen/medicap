...
@Component({
  ...
  styleUrls: ['./pmreport.component.css']
})
export class PmreportComponent implements OnInit {
    ...
    getApprovedSPecificationByTypeAndStatus(){
      this.service.get('qc/specification/raw.php?type=getApprovedSPecificationByTypeAndStatus&status=Approved&spec_type=Packing Material').subscribe(response => {
