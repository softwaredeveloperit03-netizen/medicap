...
export class RequestComponent implements OnInit {
  ...
  getApprovedSpecifications(){
    this.service.get('qc/specification/retest.php?type=getApprovedSpecifications').subscribe(response=>{
...
*/
  ...
  saveForm(data) {
    ...
    this.service.post('qc/specification/retest.php?type=saveRevisionRequest&specification_no='+this.selectedSpec['specification_no']+'&version_no='+this.selectedSpec['version_no'], JSON.stringify(temp)).subscribe(response => {
