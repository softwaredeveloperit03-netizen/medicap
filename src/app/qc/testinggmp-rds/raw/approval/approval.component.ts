...
export class ApprovalComponent implements OnInit {
  ...
  getCheckedTestingReport() {
    this.service.loadList('qc/testing/raw.php?type=getCheckedTestingReport&material_type='+encodeURIComponent(this.material_type || 'Raw Material')).subscribe(response => {
  ...
  openDigiSign(status){
    ...
    this.temp['retest_month'] = this.selectedTesting['retest_month'];
    this.temp['material_code'] = this.selectedTesting['material_code'];
    this.temp['ar_no'] = this.selectedTesting['ar_no'];
    this.temp['grn_no'] = this.selectedTesting['grn_no'];
    this.temp['batch_no'] = this.selectedTesting['batch_no'];
  ...
  approveTesting(){
      ...
      const remark = prompt('Enter Approval/Rejection Remark *');
      if (remark == null || String(remark).trim() === '') {
        alert('Approval/Rejection Remark is required.');
        return;
      }
    ...
    this.service.post('qc/testing/raw.php?type=approveTesting',JSON.stringify(payload)).subscribe(response => {
      if (response['status']) {
