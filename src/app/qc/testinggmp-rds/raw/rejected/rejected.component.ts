...
export class RejectedComponent implements OnInit {
  ...
  getRejectedTestingLog() {
    this.service.get('qc/testing/raw.php?type=getRejectedTestingLog&material_type='+this.material_type).subscribe(response => {
      this.results = Array.isArray(response) ? response : [];
    });
  }

  downloadRejectedTestingLog() {
    this.service.open('qc/testing/raw.php?type=downloadRejectedTestingLog&material_type=' + this.material_type);
  }
...
exportToExcel(): void {
  const fileName = 'Rejected_Testing_Log.xlsx';
  ...
  XLSX.utils.book_append_sheet(wb, ws, 'Rejected Testing Log');
