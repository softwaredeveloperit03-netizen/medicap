...
export class ApprovalComponent implements OnInit {
  ...
  getApprovedLeave() { 
    this.service.get('hr/leaveForm.php?type=getPendingLeaveForDept&approver='+localStorage.getItem('loger_id') + '&department_name=' + localStorage.getItem('department')).subscribe(response => {
  ...
  pending
    ...
    update(status) {
     this.service.post('hr/leaveForm.php?type=updateLeaveFormHOD&status='+status +'&id='+this.selectedResult['id'] 
