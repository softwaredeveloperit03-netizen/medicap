...
export class NewComponent implements OnInit {
  ...
  getInprocessCapa() {
    this.service
      .get(
        'qms/capa2.php?type=getExtendedCapaQa&deptName=' +
  ...
  update(data) {
    ...
    formData.append('followUpqaComments', this.followUpqaComments);
    ...
    this.service
      .post('qms/capa2.php?type=ExtendedCapaQaHead', formData)
      .subscribe((response) => {
