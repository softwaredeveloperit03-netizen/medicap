...
@Component({
  selector: 'app-exteded',
  templateUrl: './exteded.component.html',
  styleUrls: ['./exteded.component.css'],
})
export class ExtededComponent implements OnInit {
  isView = false;
  results;
  ...
  getInprocessCapa() {
    this.service
      .get(
        'qms/capa2.php?type=getFinalQaComment&deptName=' +
  ...
  update(data) {
    ...
    formData.append('QaHeadCommnt', this.QaHeadCommnt);
    ...
    this.service
      .post('qms/capa2.php?type=QaDeptComment', formData)
      .subscribe((response) => {
