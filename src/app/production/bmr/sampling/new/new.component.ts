...
export class NewComponent implements OnInit {
  ...
  getCompletedBatches() {
    this.service.get('production/bmr/sampling.php?type=getPendingBatches').subscribe(response => {
  ...
  send(){
    ...
    temp['batch_qty']=this.selectedResult['batch_qty'];
    ...
    this.service.post('production/bmr/sampling.php?type=sendIntimation',JSON.stringify(temp)).subscribe(response=>{
