...
export class LogComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.getChallansLogGeneralMaterials();
  ...
  getChallansLogGeneralMaterials() {
    this.service.get('store/challan.php?type=getChallansLogGeneralMaterials').subscribe(response => {
