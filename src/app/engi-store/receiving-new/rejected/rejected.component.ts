...
export class RejectedComponent implements OnInit {
  ...
  downloadLog(){
    this.service.open('store/raw.php?type=receivingMaterialLogPDF&log_source=general&receiving_status=Rejected&material_type=' + encodeURIComponent(this.material_type));
  }
