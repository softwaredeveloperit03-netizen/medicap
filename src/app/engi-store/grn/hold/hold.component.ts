...
export class HoldComponent implements OnInit {
  ...
  grades;
  ngOnInit() {
    this.getHoldGrnGeneralMaterials();
  }
 
  results;
  material_type = 'Stationary';
  getHoldGrnGeneralMaterials() {
    this.service.get('store/raw.php?type=getHoldGrnGeneralMaterials&material_type='+this.material_type).subscribe(response => {
