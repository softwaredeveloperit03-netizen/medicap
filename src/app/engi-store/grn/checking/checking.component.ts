...
export class CheckingComponent implements OnInit {
  ...
  grades;
  ngOnInit() {
    this.getPendingCheckingGRNGeneralMaterials();
  }
 
  results;
  material_type = 'Stationary';
  getPendingCheckingGRNGeneralMaterials() {
    this.service.get('store/raw.php?type=getPendingCheckingGRNGeneralMaterials&material_type='+this.material_type).subscribe(response => {
  ...
  updateGrn(status) {
     ...
     this.service.post('store/raw.php?type=updateGRNGeneralMaterial', JSON.stringify(temp)).subscribe(response => {
