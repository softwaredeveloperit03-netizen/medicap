...
export class CheckingComponent implements OnInit {
  ...
  ngOnInit() {
    this.getCheckingWeighingGeneralMaterials();
  }


  results;
  material_type = 'Stationary';
  getCheckingWeighingGeneralMaterials() {
    this.service.get('store/raw.php?type=getCheckingWeighingGeneralMaterials&material_type='+this.material_type).subscribe(response => {
