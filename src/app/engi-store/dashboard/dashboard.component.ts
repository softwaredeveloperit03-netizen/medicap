...
export interface EngiStoreCategory {
  id: string;
  name: string;
  icon: string;
}
...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'engi_store_dashboard_category';
  private readonly paletteKey = 'engi_store_dashboard_palette';

  readonly categories: EngiStoreCategory[] = [
    { id: 'inward', name: 'Inward', icon: 'fa-truck' },
  ...
  readonly managementCards: DashCard[] = [
    // {
    //   id: 'challan',
    //   title: 'Challans Verif.',
    //   description: 'Challan verification',
    //   route: '/engi-store/challan',
    //   icon: 'fa-check',
    //   category: 'Inward',
    //   gradient: G.indigo,
    //   categoryId: 'inward',
    ...
    // {
    //   id: 'weighing',
    //   title: 'Weighning/Counting',
    //   description: 'Weighing and counting',
    //   route: '/engi-store/weighing',
    ...
    // },
    {
      id: 'damage',
      title: 'Damage',
      description: 'Damage material records',
      route: '/engi-store/damage',
      icon: 'fa-check-circle',
      category: 'Inventory',
      gradient: G.steel,
    ...
    },
    {
      id: 'stock',
      title: 'Stock Book',
      description: 'Stock book records',
      route: '/engi-store/stock',
      icon: 'fa-book',
      category: 'Inventory',
      gradient: G.slate,
      categoryId: 'inventory',
    ...
    {
      id: 'barcodePriting',
      title: 'Barcode Priting',
      description: 'Barcode printing',
      route: '/engi-store/barcodePriting',
      icon: 'fa-tools',
      category: 'Inventory',
      gradient: G.navy,
      categoryId: 'inventory',
  ...
  get currentCategory(): EngiStoreCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Engi-Store hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: EngiStoreCategory): string {
    return cat.id;
  }
