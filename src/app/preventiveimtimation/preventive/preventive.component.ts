...
export class PreventiveComponent implements OnInit {
 ...
 constructor(private service:DataAccessService) { }
  ...
  getIntimation() {
   ...
   this.service.get('engineering/preventive.php?type=getIntimations&intimation_status=Inprocess&due_type=Preventive&Inti_department='+localStorage.getItem('department')).subscribe(response => {
