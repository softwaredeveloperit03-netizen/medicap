...
saveprocedure(data){
  ...
  getpendingdraft() {
    this.service.get('sops.php?type=getpendingdraft&department1=Planning').subscribe(response => {
  ...
  getpendingdraftrecord(id) {
    this.service.get('sops.php?type=getpendingdraftrecord&department1=Planning&id=' + id).subscribe((response: any) => {
