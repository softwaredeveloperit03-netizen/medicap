...
export class InitiateCheckingComponent implements OnInit {
  init = {
    ...
    statusbar: false,
    content_style:
      'body { font-size: 12pt; font-family: Times; } ol{counter-reset: item}ol > li{display: block}ol > li:before {content: counters(item, ".") ". ";counter-increment: item}',
  ...
  getpendinginitiation() {
    this.service
      .get('sops.php?type=getpendinginitiation&department1=Planning')
      .subscribe((response) => {
  ...
  update(status) {
    ...
    this.service
      .post(
        'sops.php?type=checkinitiation&status=' +
          status +
          '&id=' +
  ...
  Download() {
    this.service.open(
      'sops.php?type=download_Sop&id=' + this.selectedResult['id']
    );
  }
  ...
  savescopeForm(data) {
    ...
    this.service
      .post(
        'sops.php?type=saveScope&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  saveadds1Form(data) {
    ...
    this.service
      .post(
        'sops.php?type=saveadds1&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  saveadds2Form(data) {
    ...
    this.service
      .post(
        'sops.php?type=saveadds2&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  saveadds3Form(data) {
    ...
    this.service
      .post(
        'sops.php?type=saveadds3&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  saveadds4Form(data) {
    ...
    this.service
      .post(
        'sops.php?type=saveadds4&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  saveadds5Form(data) {
    ...
    this.service
      .post(
        'sops.php?type=saveadds5&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  saveDefination(data) {
    ...
    this.service
      .post(
        'sops.php?type=saveDefination&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  saveabbreviationForm(data) {
    ...
    this.service
      .post(
        'sops.php?type=saveabbreviationForm&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  savetrainingList(data) {
    ...
    this.service
      .post(
        'sops.php?type=savetrainingList&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  savedistributionList(data) {
    ...
    this.service
      .post(
        'sops.php?type=savedistributionList&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  saverevisionList(data) {
    ...
    this.service
      .post(
        'sops.php?type=saverevisionList&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  saveAssDocument(data) {
    ...
    this.service
      .post(
        'sops.php?type=saveAssDocument&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  saverolesform(data) {
    ...
    this.service
      .post(
        'sops.php?type=saverolesform&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  savepurpose(data) {
    ...
    this.service
      .post(
        'sops.php?type=savePurpose&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
  ...
  saveprocedure(data) {
    ...
    this.service
      .post(
        'sops.php?type=saveprocedure&ID=' + this.selectedResult['id'],
        JSON.stringify(temp)
      )
      .subscribe((response) => {
        if (response['status'] == 'success') {
