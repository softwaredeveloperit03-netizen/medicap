...
export class DispenseComponent implements OnInit {
  ...
  saveLineClearance(data) {
    ...
    this.service.post('store/dispensing.php?type=saveLineClearance&id=' + this.selectedResult['id'] + '&bmr_no=' + this.selectedResult['bmr_no'], JSON.stringify(this.selectedResult['clearances'])).subscribe(response => {
