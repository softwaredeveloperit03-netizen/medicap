...
export class LogComponent implements OnInit {
  ...
  getDispensingLog(){
    this.service.get('store/dispensing.php?type=getDispensingLog&product_type='+this.product_type+'&to_date='+this.to_date+'&from_date='+this.from_date).subscribe(response=>{
