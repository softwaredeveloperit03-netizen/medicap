...
export class LogComponent implements OnInit {
  ...
  download(){
    this.service.open('equipments.php?type=downloadEquipmentCleaningLog&equipment_name='+encodeURIComponent(this.equipment_name || '') +'&from_date='+encodeURIComponent(this.from_date || '')+'&to_date='+encodeURIComponent(this.to_date || '') +'&equipment_type='+encodeURIComponent(this.equipment_type || ''));
  }
