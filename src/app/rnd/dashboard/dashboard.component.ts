...
const G = {
  ...
  violet: 'linear-gradient(135deg, #5b21b6 0%, #7c3aed 100%)',
...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'rnd_dashboard_category';
  private readonly paletteKey = 'rnd_dashboard_palette';

  readonly categories: RndCategory[] = [
    { id: 'project', name: 'Project Lifecycle', icon: 'fa-flask' },
  ...
  readonly managementCards: DashCard[] = [
    {
      ...
      description: 'Start a new R&D project',
      route: '/rnd/product-dev',
      icon: 'fa-plus-circle',
    ...
    },
    {
      id: 'predevelopment',
      title: 'Pre-Dev. Study',
      description: 'Pre-development study',
      route: '/rnd/predevelopment',
      icon: 'fa-book',
      category: 'Project Lifecycle',
      gradient: G.teal,
      categoryId: 'project',
    ...
    {
      id: 'dev-trial',
      title: 'Development Trial',
      description: 'Development trial batches',
      route: '/rnd/dev-trial',
      icon: 'fa-flask',
      category: 'Project Lifecycle',
      gradient: G.amber,
    ...
    {
      id: 'optimisation',
      title: 'Optimisation Batches',
      description: 'Optimisation batch records',
      route: '/rnd/optimisation',
      icon: 'fa-cogs',
      category: 'Project Lifecycle',
      gradient: G.indigo,
      categoryId: 'project',
    ...
    {
      id: 'scaleup',
      title: 'Scale-up Study',
      description: 'Scale-up study records',
      route: '/rnd/scaleup',
      icon: 'fa-chart-line',
      category: 'Project Lifecycle',
      gradient: G.sky,
    ...
    },
    {
      ...
      description: 'Stability study records',
      route: '/rnd/stability',
      icon: 'fa-vial',
      category: 'Project Lifecycle',
      gradient: G.copper,
    ...
    },
    {
      ...
      description: 'Technology transfer records',
      route: '/rnd/technology',
    ...
    {
      id: 'unitformula',
      title: 'Master Formula Rec.',
      description: 'Master formula records',
      route: '/unitformula',
  ...
  get currentCategory(): RndCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('R&D hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: RndCategory): string {
    return cat.id;
  }
