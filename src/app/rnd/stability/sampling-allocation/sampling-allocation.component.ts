...
export class SamplingAllocationComponent implements OnInit {
  ...
  saveSampling(data) {
    ...
    this.service.get('stability.php?type=allocateSamplingPerson&stability_no=' + this.selectedStability['id'] + '&sampling_person=' + this.sampling_person).subscribe(response => {
