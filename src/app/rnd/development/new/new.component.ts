...
export class NewComponent implements OnInit {
  ...
  getPendingDevTrials(){
    this.service.get('rnd/optimisation.php?type=getPendingOptimisations').subscribe(response=>{
  ...
  save() {
    ...
    this.service.post('rnd/optimisation.php?type=saveOptimisationTrial', JSON.stringify(temp)).subscribe(response => {
