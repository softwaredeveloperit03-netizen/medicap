...
export class HistoryComponent implements OnInit {
  ...
  getReports(){
    this.service.get('qc/specification/stability.php?type=getSpecificationsLog&dosage_form=' + this.dosage_form + '&grade=' + this.grade + '&status=' + this.status).subscribe((response:any)=>{
