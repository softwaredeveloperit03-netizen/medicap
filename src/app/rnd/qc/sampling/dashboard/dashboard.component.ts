...
export class DashboardComponent implements OnInit {
  cards: QcDeptCard[] = [
    ...
    { id: 'finish', title: 'Finish Material', route: 'finish', icon: 'fa-boxes', category: 'Modules', gradient: 'linear-gradient(135deg, #43e97b 0%, #764ba2 100%)' },
    { id: 'packing', title: 'Packing Material', route: 'packing', icon: 'fa-th-large', category: 'Modules', gradient: 'linear-gradient(135deg, #fa709a 0%, #764ba2 100%)' },
  ];
