...
export class DashboardComponent implements OnInit {
  cards: QcDeptCard[] = [
    ...
    { id: 'request', title: 'Label Request', route: 'request', icon: 'fa-tags', category: 'Modules', gradient: 'linear-gradient(135deg, #4facfe 0%, #764ba2 100%)' },
    { id: 'approval', title: 'Additional Labels for Approval', route: 'approval', icon: 'fa-check-circle', category: 'Modules', gradient: 'linear-gradient(135deg, #43e97b 0%, #764ba2 100%)' },
