...
export class NewComponent implements OnInit {
  ...
  getMoaSpecification() {
    this.service.get('qc/method.php?type=getPendingFinishMOA').subscribe(response => {
  ...
  saveMOA(data) {
    ...
    this.service.post('qc/moa/finish.php?type=saveMOA', JSON.stringify(specification)).subscribe(response => {
