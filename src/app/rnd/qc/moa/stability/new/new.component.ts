...
export class NewComponent implements OnInit {
  ...
  getMoaSpecification() {
    this.service.get('qc/method.php?type=getPendingStabilityMOA').subscribe(response => {
  ...
  saveMOA(data) {
    ...
    this.service.post('qc/moa/stability.php?type=saveMOA', JSON.stringify(specification)).subscribe(response => {
