...
export class DashboardComponent implements OnInit {
  cards: QcDeptCard[] = [
    ...
    { id: 'awaiting', title: 'Awaiting Tests', route: 'awaiting', icon: 'fa-clock', category: 'Modules', gradient: 'linear-gradient(135deg, #4facfe 0%, #764ba2 100%)' },
    { id: 'approval', title: 'Approval Pending', route: 'approval', icon: 'fa-check-circle', category: 'Modules', gradient: 'linear-gradient(135deg, #43e97b 0%, #764ba2 100%)' },
