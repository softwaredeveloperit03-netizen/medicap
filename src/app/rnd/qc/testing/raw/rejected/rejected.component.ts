...
export class RejectedComponent implements OnInit {
  ...
  getPendingTesting() {
    this.service.get('qc/testing/raw.php?type=getRejectedTestingReport').subscribe(response => {
  ...
  submitOOS(data) {
    ...
    this.service.post('qc/testing/raw.php?type=reportError', JSON.stringify(data)).subscribe(response => {
