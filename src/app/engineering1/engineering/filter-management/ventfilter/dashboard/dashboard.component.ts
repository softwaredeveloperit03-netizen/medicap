...
export class DashboardComponent implements OnInit {
  cards: QcDeptCard[] = [
    ...
    { id: 'non-critical', title: 'List of vent fltr-Noncriti', route: 'non-critical', icon: 'fa-clipboard-list', category: 'Modules', gradient: 'linear-gradient(135deg, #4facfe 0%, #764ba2 100%)' },
    { id: 'replacement', title: 'Vent Fltr replac Rec', route: 'replacement', icon: 'fa-exchange-alt', category: 'Modules', gradient: 'linear-gradient(135deg, #43e97b 0%, #764ba2 100%)' },
    { id: 'integrity1', title: 'Integrity test report', route: 'integrity1', icon: 'fa-file-alt', category: 'Modules', gradient: 'linear-gradient(135deg, #fa709a 0%, #764ba2 100%)' },
    ...
    { id: 'schedule', title: 'Schedule Vent filter replacement', route: 'schedule', icon: 'fa-th-large', category: 'Modules', gradient: 'linear-gradient(135deg, #a1c4fd 0%, #764ba2 100%)' },
  ];
