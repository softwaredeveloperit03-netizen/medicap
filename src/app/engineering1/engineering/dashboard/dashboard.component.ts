...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'engineering_dashboard_category';
  private readonly paletteKey = 'engineering_dashboard_palette';

  readonly categories: EngineeringCategory[] = [
    { id: 'maintenance', name: 'Maintenance', icon: 'fa-tools' },
    { id: 'systems', name: 'Systems', icon: 'fa-cogs' },
  ...
  readonly managementCards: DashCard[] = [
    ...
    },
    {
      id: 'ahu',
      title: 'AHU Section',
      description: 'Air handling unit records',
      route: '/engineering/ahu',
      icon: 'fa-wind',
      category: 'Systems',
      gradient: G.amber,
      categoryId: 'systems',
      showWhenNutraceutical: false,
    },
    {
      id: 'equip-qualification',
      title: 'Equipment Qualif.',
      description: 'Equipment qualification',
      route: '/engineering/equip-qualification',
      icon: 'fa-toolbox',
      category: 'Systems',
      gradient: G.steel,
      categoryId: 'systems',
    ...
    {
      id: 'water',
      title: 'Water System Docs.',
      description: 'Water system documentation',
      route: '/engineering/water',
      icon: 'fa-tint',
      category: 'Systems',
      gradient: G.navy,
      categoryId: 'systems',
    ...
    {
      id: 'electricity',
      title: 'Electricity Cons.',
      description: 'Electricity consumption records',
      route: '/engineering/electricity',
      icon: 'fa-bolt',
      category: 'Systems',
      gradient: G.copper,
      categoryId: 'systems',
    },
    {
      ...
      description: 'Air compressor operations',
      route: '/engineering/aircompressor',
      icon: 'fa-fan',
      category: 'Systems',
      gradient: G.slate,
      categoryId: 'systems',
    ...
    {
      id: 'en020',
      title: 'Chilling & Brine Plant',
      description: 'Chilling and brine plant records',
      route: '/engineering/en020',
      icon: 'fa-snowflake',
      category: 'Systems',
      gradient: G.indigo,
      categoryId: 'systems',
    ...
    {
      id: 'external',
      title: 'Equip. History Card',
      description: 'Equipment history cards',
      route: '/engineering/external',
      icon: 'fa-file-alt',
      category: 'Systems',
      gradient: G.blue,
      categoryId: 'systems',
    ...
    {
      id: 'nitrogen',
      title: 'Op. of Nitro. Plant',
      description: 'Nitrogen plant operations',
      route: '/engineering/nitrogen',
      icon: 'fa-industry',
      category: 'Systems',
      gradient: G.teal,
      categoryId: 'systems',
    ...
    {
      id: 'eurotherm',
      title: 'Eurotherm Database',
      description: 'Eurotherm database records',
      route: '/engineering/eurotherm',
      icon: 'fa-industry',
      category: 'Other',
      gradient: G.amber,
      categoryId: 'other',
  ...
  get currentCategory(): EngineeringCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Engineering hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: EngineeringCategory): string {
    return cat.id;
  }
