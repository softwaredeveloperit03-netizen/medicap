...
@Component({
  selector: 'app-inspcheck',
  templateUrl: './inspcheck.component.html',
  styleUrls: ['./inspcheck.component.css']
})
export class InspcheckComponent implements OnInit {
 ...
 constructor(private service:DataAccessService) { }
  ...
  getMaintenanceData() {
   ...
   this.service.get('engineering/preventive.php?type=getPmForChecking&status=Checking&due_type=Inspection').subscribe(response => {
