...
@Component({
  selector: 'app-inspapprove',
  templateUrl: './inspapprove.component.html',
  styleUrls: ['./inspapprove.component.css']
})
export class InspapproveComponent implements OnInit {
 ...
 constructor(private service:DataAccessService) { }
  ...
  getMaintenanceData() {
   ...
   this.service.get('engineering/preventive.php?type=getPmForChecking&status=Checked&due_type=Inspection').subscribe(response => {
