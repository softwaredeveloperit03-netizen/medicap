...
export class NewComponent implements OnInit {
  ...
  {"CheckPoints": "To check the ventilation system.","observation": "", "compliance": "", "completion_date": ""},
  ...
  saveData(data){
    ...
    this.service.post('engineering/premises.php?type=saveFinishGoods',JSON.stringify(temp)).subscribe(response=>{
      if(response['status']=="success"){
        this.router.navigate(['/engineering/premises/fgstore'])
