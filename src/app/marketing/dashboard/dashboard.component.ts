...
export class DashboardComponent implements OnInit {
  ...
  private readonly storageKey = 'marketing_dashboard_category';
  private readonly paletteKey = 'marketing_dashboard_palette';

  readonly categories: MarketingCategory[] = [
    { id: 'sales', name: 'Sales', icon: 'fa-handshake' },
    { id: 'support', name: 'Support', icon: 'fa-headset' },
    { id: 'other', name: 'Other', icon: 'fa-th-large' },
  ];
  ...
  readonly managementCards: DashCard[] = [
    ...
    },
    {
      id: 'po',
      title: 'Client PO/FO',
      description: 'Client purchase and factory orders',
      route: '/marketing/po',
    ...
    {
      id: 'complaint',
      title: 'Market Complaint',
      description: 'Log and track market complaints',
      route: '/marketing/complaint',
      icon: 'fa-envelope',
      category: 'Support',
      gradient: G.amber,
      categoryId: 'support',
    },
    {
      ...
      description: 'Customer feedback and logs',
      route: '/marketing/feedback/log',
      icon: 'fa-comments',
      category: 'Support',
      gradient: G.navy,
      categoryId: 'support',
    },
    {
      ...
      description: 'Commission agent management',
      route: '/marketing/agent/log',
      icon: 'fa-user-tie',
      category: 'Support',
      gradient: G.steel,
      categoryId: 'support',
    ...
    {
      id: 'technical',
      title: 'Tech. Doc. Request',
      description: 'Technical document requests',
    ...
    },
    {
      ...
      description: 'Request and track samples',
      route: '/marketing/sample',
      icon: 'fa-flask',
      category: 'Other',
      gradient: G.teal,
      categoryId: 'other',
    },
    {
      id: 'crmTracking',
      title: 'CRM Tracking',
      description: 'CRM tracking and reports',
      route: '/marketing/crmTracking',
    ...
    this.service
      .get(
        'hr/employee.php?type=getrights&emp_id=' +
          ...
          '&dep_name=' +
          encodeURIComponent(this.loggedInDept || 'Marketing')
      )
  ...
  get currentCategory(): MarketingCategory | undefined {
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Marketing hub navigation failed:', card.route, err);
    });
  }
  ...
  trackByCatId(_index: number, cat: MarketingCategory): string {
    return cat.id;
  }
