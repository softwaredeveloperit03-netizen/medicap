...
export class CoopComponent implements OnInit {
  ...
  Submit(data) {
    ...
    this.service.post('Dossier/Dossier.php?type=savecopplicense&docType=EXPORT', uploadData).subscribe(response => {
  ...
  getDomesticData() {
    this.service.get('Dossier/Dossier.php?type=getDomesticLog&docType=EXPORT&plantID='+this.plantID).subscribe(response => {
