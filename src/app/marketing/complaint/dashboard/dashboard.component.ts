...
export class DashboardComponent implements OnInit {
  ...
  sidebarTitle = 'Complaint Modules';
  sectionLabel = 'Complaint Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'marketing_complaint_dashboard_category';
  private readonly paletteKey = 'marketing_complaint_dashboard_palette';

  readonly categories: HubCategory[] = [
    { id: 'complaints', name: 'Complaints', icon: 'fa-exclamation-triangle' },
  ];
  ...
  readonly managementCards: DashCard[] = [
    {
      id: 'new',
      title: 'New Complaint',
      description: 'Register new market complaint',
      route: '/marketing/complaint/new',
      icon: 'fa-bug',
      category: 'Complaints',
      gradient: G.indigo,
    ...
    },
    {
      ...
      description: 'View and act on pending complaints',
      route: '/marketing/complaint/action',
    ...
    {
      id: 'inprocess',
      title: 'Inprocess Complaints',
      description: 'Complaints in progress',
      route: '/marketing/complaint/inprocess',
      icon: 'fa-spinner',
      category: 'Complaints',
      gradient: G.teal,
      categoryId: 'complaints',
    },
    {
      ...
      description: 'Full complaints log',
      route: '/marketing/complaint/log',
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Complaint hub navigation failed:', card.route, err);
    });
  }
  ...
  onCloseDashboard(): void {
    this.deptNav.goBack(this.route, '/marketing');
  }
}
