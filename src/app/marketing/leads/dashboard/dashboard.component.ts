...
export class DashboardComponent implements OnInit {
  ...
  sidebarTitle = 'Lead Modules';
  sectionLabel = 'Lead Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'marketing_leads_dashboard_category';
  private readonly paletteKey = 'marketing_leads_dashboard_palette';

  readonly categories: HubCategory[] = [
    { id: 'leads', name: 'Leads', icon: 'fa-bullseye' },
    { id: 'clients', name: 'Clients', icon: 'fa-user-plus' },
  ];
  ...
  readonly managementCards: DashCard[] = [
    {
      ...
      route: '/marketing/leads/newClient',
      icon: 'fa-user-plus',
      category: 'Clients',
      gradient: G.indigo,
      categoryId: 'clients',
    ...
    },
    {
      ...
      description: 'Create new lead or enquiry',
      route: '/marketing/leads/firstRes',
      icon: 'fa-comments',
      category: 'Leads',
      gradient: G.blue,
      categoryId: 'leads',
    ...
    {
      id: 'track',
      title: 'Track Lead / Enquiry',
      description: 'Track lead or enquiry status',
      route: '/marketing/leads/track',
      icon: 'fa-bullseye',
      category: 'Leads',
      gradient: G.teal,
      categoryId: 'leads',
    ...
    {
      id: 'log',
      title: 'Log - Lead / Enquiry',
      description: 'View lead and enquiry log',
      route: '/marketing/leads/log',
      icon: 'fa-file-alt',
      category: 'Leads',
      gradient: G.amber,
      categoryId: 'leads',
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Leads hub navigation failed:', card.route, err);
    });
  }
