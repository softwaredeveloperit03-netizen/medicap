...
export class DashboardComponent implements OnInit {
  pageTitle = 'Technical Documents';
  sidebarTitle = 'Technical Modules';
  sectionLabel = 'Technical Modules';
  searchQuery = '';
  ...
  private readonly storageKey = 'marketing_technical_dashboard_category';
  private readonly paletteKey = 'marketing_technical_dashboard_palette';

  readonly categories: HubCategory[] = [
    { id: 'technical', name: 'Technical', icon: 'fa-file-alt' },
  ];
  ...
  readonly managementCards: DashCard[] = [
    {
      ...
      description: 'Request technical documents',
      route: '/marketing/technical/requests',
      icon: 'fa-file-alt',
      category: 'Technical',
      gradient: G.indigo,
    ...
    {
      id: 'log',
      title: 'Technical Document Log',
      description: 'View technical document log',
      route: '/marketing/technical/log',
      icon: 'fa-book',
      category: 'Technical',
      gradient: G.blue,
      categoryId: 'technical',
  ...
  openCard(card: DashCard, event?: Event): void {
    ...
    void this.router.navigateByUrl(card.route).catch((err) => {
      console.error('Technical hub navigation failed:', card.route, err);
    });
  }
