...
$html .= '<table class="so-form" cellpadding="3" cellspacing="0" border="1" style="width:100%; margin-bottom:5px;">
    <tr>
        ...
        <td style="width:22%;font-size:' . $fs . ';"><b>FORM NO.:</b> FQC-005-09-A</td>
    </tr>
    <tr>
...
$html .= '<table class="so-grid" cellpadding="4" cellspacing="0" border="1" style="width:100%; margin-bottom:5px;">
    <tr>
        <td style="width:50%; vertical-align:top;">
            <table cellpadding="2" cellspacing="0" border="0" style="width:100%;">
                <tr>
                    <td style="width:18%;font-size:' . $fs . ';font-weight:bold;">Ship To</td>
                    <td style="font-size:' . $fs . ';">' . so_pdf_esc($order['ship_to']) . '</td>
                    <td style="width:12%;font-size:' . $fs . ';font-weight:bold;">P.O.#</td>
                    <td style="width:22%;font-size:' . $fs . ';">' . so_pdf_esc($order['po_number']) . '</td>
                </tr>
                <tr>
                    <td style="font-size:' . $fs . ';font-weight:bold;">Address</td>
                    <td colspan="3" style="font-size:' . $fs . ';min-height:36px;">' . so_pdf_multiline($order['ship_to_address']) . '</td>
                </tr>
            </table>
        </td>
        <td style="width:50%; vertical-align:top;">
            <table cellpadding="2" cellspacing="0" border="0" style="width:100%;">
                <tr>
                    <td style="width:18%;font-size:' . $fs . ';font-weight:bold;">From</td>
...
if (trim((string) ($order['quotation_ref'] ?? '')) !== '') {
    $html .= '<div style="font-size:' . $fs . ';margin-bottom:3px;"><b>Quotation Ref:</b> ' . so_pdf_esc($order['quotation_ref']) . '</div>';
}

if (trim((string) ($order['tests_required'] ?? '')) !== '') {
    $html .= '<div style="font-size:' . $fs . ';margin-bottom:4px;"><b>Tests Required:</b><br/>' . so_pdf_multiline($order['tests_required']) . '</div>';
}

$html .= '<table class="so-grid" cellpadding="4" cellspacing="0" border="1" style="width:100%; margin-bottom:8px;">
    <tr style="background-color:' . $hdrGrey . ';font-size:' . $fs . ';font-weight:bold;text-align:center;">
        <td style="width:22%;">Lab sample #</td>
        <td style="width:12%;">Quantity</td>
        <td style="width:22%;">Lot/Batch#</td>
...
$html .= '<table class="so-grid" cellpadding="4" cellspacing="0" border="1" style="width:100%;">
    <tr style="font-size:' . $fs . ';">
        <td style="width:18%;font-weight:bold;">Packaged By</td>
        <td style="width:32%;">' . so_pdf_esc($packagedBy) . '</td>
        <td style="width:10%;font-weight:bold;">Date</td>
        <td style="width:40%;">' . so_pdf_esc(so_pdf_date($order['packaged_date'])) . '</td>
    </tr>
    <tr style="font-size:' . $fs . ';">
