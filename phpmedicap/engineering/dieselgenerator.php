...
if($result->num_rows > 0) {
    ...
    if($_GET["type"] == "savedieselgenerator") {
       $sql = "INSERT INTO DieselGenerator (
                plant_id, 
                log_date,
                time_from,
                time_to,
...
if ($conn->query($sql)) {
    ...
    else if($_GET["type"] == "getdieselgenerator") {
        $output = array();
    ...
    $html.='   <h3 style="background-color:#DDDAD9;font-weight:bold; border: solid 1px black;text-align:center">Diesel Generator</h3>
