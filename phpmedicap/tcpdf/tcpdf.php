	...
	protected function openHTMLTagHandler($dom, $key, $cell) {
		...
		switch($tag['value']) {
			...
			case 'hr': {
				...
				$lineStyle = array(
					'color' => isset($tag['fgcolor']) ? $tag['fgcolor'] : array(0, 0, 0),
					'cap'   => (isset($tag['style']) && isset($tag['style']['cap'])) ? $tag['style']['cap'] : 'butt',
					'join'  => (isset($tag['style']) && isset($tag['style']['join'])) ? $tag['style']['join'] : 'miter',
					'dash'  => (isset($tag['style']) && isset($tag['style']['dash'])) ? $tag['style']['dash'] : 0,
					'phase' => (isset($tag['style']) && isset($tag['style']['phase'])) ? $tag['style']['phase'] : 0,
				);
