        ...
        public function Header(){
            $table='
                ...
                <table>
                    ...
                    <tr>
                        <td style="width:20%;">'.$GET['annexure'].'</td>
                        <td style="width:80%; text-align:center;font-weight:bold;">'.$_GET['filename'].'</td>
                    </tr>
                </table>';
            ...
            if($_GET['user_no'] == 'GMP007'){
                ...
                <table>
                    <tr>
                         <td style="width:10%;">';
                            // $this->Image('@'.file_get_contents('http://amardeepgmp.com/gmptotal/upload/User/deep.png'),13,15,13);
                            $this->Image('http://amardeepgmp.com/gmptotal/upload/User/deep.png', 13, 15, 13);
