                ...
                <table>
                    <tr>
                     <td style="width:20%;">';
                        ...
                        //$this->Image('@'.file_get_contents('http://amardeepgmp.com/gmptotal/upload/User/deep.png'),15,12,13);
                           //$this->Image('@'.file_get_contents('http://amardeepgmp.com/gmptotal/upload/User/deep.png'),15,6,25,18);
                          //$this->Image('@'.file_get_contents('http://amardeepgmp.com/gmptotal/upload/User/amardeep-logo1.jpg'),15,6,25,18);
                             //$this->Image('@'.file_get_contents('http://'.$_SERVER['SERVER_NAME'].'/gmptotal/upload/User/dns.png'),169,8,25);
                            $table.='
                        </td>
                        <td style="width:80%;text-align:center;font-weight:bold;"><br>
                            <span style="font-family:times;font-size:17px;">AMGIS LIFESCIENCE LTD. PANOLI (Unit-2)</span><br>
                           <span style="font-family:times;font-size:11px;">Location: Plot No 631/2 GIDC, Panoli, Gujarat 394116, India.</span><br>
                        </td>
                    </tr>
                    <tr>
                       
                        <td style="width:100%; text-align:center;font-weight:bold;">HR And Administration</td>
                       
                    </tr>
                    
                     <tr>
                        <td style="width:100%; text-align:center;font-weight:bold;">'.$_GET['filename'].'</td>
                    </tr>
                    <tr>
                       <td style="width:50%;"> <b>Format No.</b>: HR/015/FM-002/00</td>
                       <td style="width:50%;;"> <b>Change Control No.</b>: </td>
                    </tr>
                     <tr>
                       <td style="width:50%;"><b> Effective Date</b>: </td>
                       <td style="width:50%;"> <b>Review Date</b>: </td>
                    </tr>
                     <tr>
                       <td style="width:50%;"><b> Reference SOP No.</b>: ALL/HR/015/00  </td>
                       <td style="width:50%;"><b> Page No.</b>1 of 1 </td>
                    </tr>
                </table>';
