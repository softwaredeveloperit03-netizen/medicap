...
class MYPDF extends TCPDF {
    ...
    $data = file_get_contents("../lot.json");
    $data = json_decode($data, true);
    $data = $data[$_GET["lot_no"]];
    $html='
    <style>
    table tr td {
    ...
    <table cellpadding="5">
        <thead>
            <tr>
                <td style="width:62%;"><b style="font-size:20px;">DEMO</b> Chemicals &amp; Laboratories (P) Ltd. <br>W – 15, MIDC, DEMO,<br>DEMO (E), Dist – Pune – 411 015.</td>
                <td style="width:38%; text-align:center;">LOT MANUFACTURING RECORD – '.$data['product_name'].'</td>
            </tr>
        </thead>
        <tbody>
            <tr>
            ...
            <tr>
                <td>SOP No.  :</td>
                <td colspan="3">DEMO/PDN/SOP/051</td>
                <td>Revision Date</td>
                <td></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width:25%;">Lot No. '.$data['lot_no'].'</td>
                <td style="width:25%;">Lot Size. '.$data['qty'].' '.$data['unit'].'</td>
                <td style="width:25%;">Mfg. Date. '.$data['mfg_date'].'</td>
                <td style="width:25%;">Exp. Date. '.$data['exp_date'].'</td>
            </tr>
            <tr>
                <td colspan="2">Lot Starting Date : '.$data['start_date'].'</td>
                <td colspan="2">Lot Completion Date : '.$data['complete_date'].'</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width:37%;">Name of Material</td>
                <td style="width:11%;">Qty. Required</td>
                <td style="width:10%;">AR. No.</td>
                <td style="width:14%;">Weighed By</td>
                <td style="width:14%;">Checked By</td>
                <td style="width:14%;">Rechecked By QA</td>
            </tr>';
            ...
            for ($j = 0; $j < count($materials); $j++) {
                ...
                $html.='
                    <tr>
                        ...
                        <td>'.$material['weight_by'].'</td>
                        <td>'.$material['check_by'].'</td>
                        <td>'.$material['approve_by'].'</td>
                    </tr>
                    ';
            ...
            <tr>
                <td colspan="4" style="border:none;"><b style="text-align: center">'.$num_pages.' LINE CLEARANCE FOR DISPENSING OF RAW MATERIAL</b></td>
            </tr>
            <tr>
            ...
            $html.='
                <tr>
                    <td style="width:50%; border:none;">Lot No. : '.$lots[$i]['lot_no'].'</td>
                    <td style="width:50%; text-align:right; border:none;">Lot Size : '.$lots[$i]['qty'].' '.$lots[$i]['unit'].'</td>
                </tr>';
                $temp = $lots[$i];
            ...
            <tr><td colspan="4" style="border:none;"></td></tr>
                ...
                <tr>
                    <td style="width:50%; border:none;"><b>Lot No. :</b> '.$lots[$i]['lot_no'].'</td>
                    <td style="width:50%; text-align:right; border:none;"><b>Lot Size :</b> '.$lots[$i]['qty'].' '.$lots[$i]['unit'].'</td>
                </tr>
                <tr>
            ...
            <tr>
                <td style="width:50%; border:none;">Dryer No.: '.$drying['dryer_no'].'</td>
                <td style="width:50%; border:none;">Total Drying Time: '.$drying['drying_time'].'</td>
            </tr>
            <tr>
                <td rowspan="2" style="width:15%">Date</td>
                <td rowspan="2" style="width:10%">Lot No.</td>
                <td rowspan="2" style="width:15%">Part No.</td>
                <td colspan="2" style="width:15%">Time</td>
                <td rowspan="2" style="width:15%">Drying Temp.</td>
                <td rowspan="2" style="width:15%">Done By </td>
            ...
            <tr style="text-align:center;">
                <td rowspan="2" style="width:10%"><b>Lot</b></td>
                <td colspan="4" style="width:60%;"><b>Unit Operations</b></td>
                <td rowspan="2" style="width:15%"><b>No of Unit Operations</b></td>
                <td rowspan="2" style="width:15%"><b>Qty (Kg)</b></td>
            </tr>
            <tr style="text-align:center;">
                <td>CF</td>
                <td>FBD</td>
                ...
                <td colspan="7">
                    <table cellpadding="5">
                        <tr>
                            ...
                            <td style="border:none; width:10%;">= Kg</td>
                        ...
                        <tr>
                            ...
                            <td style="border:none;">X   0.025 =</td>
