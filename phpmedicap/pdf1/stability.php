...
if($result->num_rows > 0){
    ...
    if($_GET['type'] == 'samplingReport'){
        $_GET['filename'] = 'SAMPLING REPORT'; $_GET['pdftype'] = 'landscape';  include("../pdfimp.php");
        $html.='
        ...
        $_GET['filename'] = 'Purchase order Report'; $_GET['pdftype'] = 'headfoot';  include("../pdfimp.php");
        ...
        $_GET['filename'] = 'Quotation Report'; $_GET['pdftype'] = 'headfoot';  include("../pdfimp.php");
        $html.='
        <table cellpadding="5" style="text-align:center;">
            <thead>
                <tr style="background-color:#DDDAD9;">
