...
if($_GET['pdftype'] == 'headfoot'){
                ...
                <table>
                    <tr>
                        <td style="width:80%;text-align:center;font-weight:bold;">
                            ...
                            <span style="font-size:9px;">Location:Ghanshyam Krupa,R.B.Kadam Marg,Bhatwadi,Ghatkopar(W),Mumbai 400084,India<br><br></span>
                        </td>
                        <td style="width:20%;">';
                            $this->Image('@'.file_get_contents('https://dns.gmpserver.online/gmptotal/upload/User/dns.png'),169,8,28);
        ...
        public function Header(){
            $table='
                ...
                <table>
                    <tr>
                        <td style="width:80%;text-align:center;font-weight:bold;">
                            <span style="font-family:times;font-size:17px;">DNS FINE CHEMICALS & LABORATORIES Pvt.Ltd</span><br>
                            <span style="font-size:9px;">W-15, MIDC Badlapur East, Thane-421503 MH, INDIA<br></span>
                        </td>
                        <td style="width:10%;">';
                            //$this->Image('@'.file_get_contents('../gmptotal/upload/User/DNS.jpg'),162,8,39);
                             $this->Image('@'.file_get_contents('https://dns.gmpserver.online/gmptotal/upload/User/DNS.jpg'),20,5,8);
    ...
    class MYPDF extends TCPDF {
        ...
        //     $this->logo = 'https://cpplgmp.com/php/gmptotal/logos/'.$var;
        //  }
        public function Header(){
                ...
                <table cellpadding="2" border="0.1">
                    ...
                    <img src="https://cpplgmp.com/php/gmptotal/logos/gmp.png" alt="" width="80" height="50"  />';
                    // $this->Image('@'.file_get_contents( $this->logo),15,6,25,10);
                        ...
                        <td style="width:80%;text-align:center;font-weight:bold;">
                            ...
                            <span style="font-family:times;font-size:17px;">  GMP Software India </span><br>
                            <span style="font-size:9px;"> 104, Garnets Bay, near Shereton Hotel, behind Chandhare Complex, Clover Park, Viman Nagar, Pune, Maharashtra 411014 </span>
                         </td>
                    </tr>
                 </table>';
               ...
               //$this->SetY(25); $this->SetFont('helvetica', 'B', 14); $this->Cell(0, 0, $_GET['filename'], 0, false, 'L', 0, '', 0, false, 'M', 'M');
                $this->SetY(22); $this->SetFont('helvetica', '', 10); 
        ...
        <tr>
            <span style="width:100%; font-size:9px;">This Work Order is Computer Generated.</span>
             ...
             $table='
              ...
              <style>td { border:solid 1px BCBBBA;font-size:9px;}</style>
                  <table style="width: 540px">
                 <tr style="background-color:black; color:white;">
                      <td style="width: 540px;text-align:center;"><b>Master BMR Digitally signed by   </b></td>
                  </tr>
                      <tr style="text-align:center;">
                        <td style="width:100px;"></td>
                         <td style="width:145px; ">Prepared By</td>
                        <td style="width:145px; ">Checked By</td>
        ...
        $this->SetY(-35);$this->writeHTML($table, true, false, false, false, '');
        // Set font
            ...
            if($_GET['user_no'] == 'GMP007'){
                ...
                <table>
                    <tr>
                        <td style="width:80%;text-align:center;font-weight:bold;">
                            <span style="font-family:times;font-size:17px;">DNS FINE CHEMICALS & LABORATORIES Pvt.Ltd</span><br>
                            <span style="font-size:9px;">Location:W-15, MIDC Badlapur East, Thane-421503 MH, INDIA<br><br></span>
                        </td>
                        <td style="width:20%;">';
                            $this->Image('@'.file_get_contents('https://dns.gmpserver.online/gmptotal/upload/User/dns.png'),169,8,25);
                            $table.='
                        </td>
                    </tr>
                </table>';
            ...
            public function Header() {
                    ...
                    <table cellpadding="2">
                        <tr>
                            ...
                            <td style="width:20%;">';
                                $this->Image('@'.file_get_contents('https://dns.gmpserver.online/gmptotal/upload/User/dns.png'),169,18,20);
                                $table.='
                            </td>
                        </tr>
                        <tr>
            ...
            if($_GET['user_no'] == 'GMP007'){
                ...
                <table cellpadding="5">
                    <tr>
                        ...
                        <td style="width:20%;">';
                            $this->Image('@'.file_get_contents('https://dns.gmpserver.online/gmptotal/upload/User/DNS.jpg'),235,8,35);
                            $table.='
                        </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                    </tr>
                    <tr>
                ...
                <table>
                    <tr>
                        ...
                        <td style="width:20%;">';
                            $this->Image('@'.file_get_contents('https://dns.gmpserver.online/gmptotal/upload/User/dns.png'),235,8,45);
                            $table.='
                        </td>
                    </tr>
                </table>';
