...
if($result->num_rows > 0) {
    ...
    }else if ($_GET["type"] == "downloadEnvironment") {
        ...
        <table border="1" cellpadding="5">
            <thead>
                <tr style="background-color:#DDDAD9;font-weight:bold; border: solid 1px black">
                    ...
                    <td style="width: 45%;">Source of Isloates</td>
                    <td style="width: 45%;">Name of Organism</td>
                </tr>
            </thead>';
        $i=1;
        $sql="SELECT * FROM environment";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                $html.='<tr nobr="true">
                        ...
                        <td style="width: 45%;">'.$row['isolates'].'</td>
                        <td style="width: 45%;">'.$row['organism'].'</td>
                    </tr>';
                $i++;
            }
        }
